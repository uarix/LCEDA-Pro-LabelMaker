...
instance.paper = function (C, q) {
	var A = (C = C || require('./node/self.js')).window,
		T = C.document,
		U = new (function () {
			function n(t, e, n) {
				var i;
			...
			function h(a, o, h, u, l) {
				...
				function t(t, e) {
					...
					(l && s) ||
						(i && s && (e.base = s),
						i && !1 !== u && (n = t.match(/^([gs]et|is)(([A-Z])(.*))$/)) && (c[n[3].toLowerCase() + n[4]] = n[2]),
						(r && !i && r.get && 'function' == typeof r.get && _.isPlainObject(r)) || (r = { value: r, writable: !0 }),
						(f(a, t) || { configurable: !0 }).configurable && ((r.configurable = !0), (r.enumerable = null != h ? h : !n)),
						d(a, t, r));
				}
				if (o) {
			...
			return h(_, {
				...
				extend: function () {
					for (var t, e, n, i = this, r = 0, s = arguments.length; r < s && (!t || !e); r++)
						...
						: '{ ' +
								U.each(
									...
									function (t, e) {
										...
										/^_/.test(e) ||
											((n = typeof t),
											this.push(e + ': ' + ('number' == n ? b.instance.number(t) : 'string' == n ? "'" + t + "'" : t)));
									},
									[],
								).join(', ') +
								' }';
				...
				statics: {
					...
					read: function (t, e, n, i) {
						...
						return (
							...
							l instanceof this || (n && n.readNull && null == l && i <= 1)
								...
								: ((l = U.create(a)),
									o && (l.__read = !0),
									(l = l.initialize.apply(l, 0 < h || h + i < u ? U.slice(t, h, h + i) : t) || l),
									o && ((t.__index = h + l.__read), (s = l.__filtered) && ((t.__filtered = s), (l.__filtered = q)), (l.__read = q)),
									l)
						);
					},
					peek: function (t, e) {
					...
					readNamed: function (t, e, n, i, r) {
						var s,
							...
							h = o !== q;
						return (
							h && ((a = t.__filtered) || ((s = this.getSource(t)), ((a = t.__filtered = U.create(s)).__unfiltered = s)), (a[e] = q)),
						...
						return (
							t &&
								Object.keys(t).forEach(function (t) {
									var e;
									t in i && ((e = r.readNamed(n, t)) !== q && (i[t] = e), (s = !0));
								}),
							s
						);
					},
					getSource: function (t) {
						var e,
							n = t.__source;
						return n === q && ((e = 1 === t.length && t[0]), (n = t.__source = e && U.isPlainObject(e) ? e : null)), n;
					},
					...
					filter: function (n, i, r, t) {
						...
						function e(t) {
							var e;
							(r && t in r) || (s && t in s) || ((e = i[t]) !== q && (n[t] = e));
						}
						if (t) {
					...
					serialize: function (t, e, n, i) {
						...
						if (
							...
							r = [];
							for (var o = 0, h = t.length; o < h; o++) r[o] = U.serialize(t[o], e, n, i);
					...
					deserialize: function (t, e, n, i, r) {
						...
						if (((n = n || {}), Array.isArray(t))) {
							...
							s = [];
							for (var l, c = (h = U.exports[h]) ? 1 : 0, f = t.length; c < f; c++) s.push(U.deserialize(t[c], e, n, u, o));
							h && ((l = s), (s = e ? e(h, l, a || r) : new h(l)));
						} else if (U.isPlainObject(t)) for (var d in ((s = {}), i && (n.dictionary = s), t)) s[d] = U.deserialize(t[d], e, n);
						return o ? s[1] : s;
					},
					...
					importJSON: function (t, a) {
						return U.deserialize('string' == typeof t ? JSON.parse(t) : t, function (t, e, n) {
							var i,
							...
							return (
								!(1 === e.length && s instanceof D) ||
									(!r && s instanceof o) ||
									((i = e[0]), U.isPlainObject(i) && ((i.insert = !1), r && (e = e.concat([{ insert: !0 }])))),
								(r ? s.set : t).apply(s, e),
								r && (a = null),
								s
							);
					...
					splice: function (t, e, n, i) {
						...
						var o = [n, i];
						e && U.push(o, e);
						for (var h = t.splice.apply(t, o), a = 0, u = h.length; a < u; a++) h[a]._index = q;
	...
	var t = {
				...
				return (
					'string' != typeof t
						...
						: ((i = (n = this._eventTypes) && n[t]),
							-1 === (r = (r = this._callbacks = this._callbacks || {})[t] = r[t] || []).indexOf(e) &&
								(r.push(e), i && i.install && 1 === r.length && i.install.call(this, t))),
					this
				);
			},
			off: function (t, e) {
					...
					return (
						s &&
							(!e || (-1 !== (n = s.indexOf(e)) && 1 === s.length)
								? (r && r.uninstall && r.uninstall.call(this, t), delete this._callbacks[t])
								: -1 !== n && s.splice(n, 1)),
						this
					);
				}
		...
		c = U.extend({
			...
			initialize: function t() {
				((at = this).settings = new U({ applyMatrix: !0, insertItems: !0, handleSize: 4, hitTolerance: 0 })),
					(this.project = null),
					(this.projects = []),
					(this.tools = []),
					(this._id = t._id++),
				...
				this.support ||
					((e = it.getContext(1, 1) || {}),
					(s.support = { nativeDash: 'setLineDash' in e || 'mozDash' in e, nativeBlendModes: x.nativeModes }),
					it.release(e)),
					this.agent ||
						((n = C.navigator.userAgent.toLowerCase()),
						(r = 'darwin' === (i = (/(darwin|win|mac|linux|freebsd|sunos)/.exec(n) || [])[0]) ? 'mac' : i),
		...
		e = U.extend(t, {
			initialize: function (t) {
				(this._scope = at), (this._index = this._scope[this._list].push(this) - 1), (!t && this._scope[this._reference]) || this.activate();
			},
			activate: function () {
						...
						if ((p.splice(0, k), s && r)) {
							...
							for (var P = w[d], M = w[f], I = 0; I < p.length; I++) {
								var A = p[I],
									...
									O = A < o,
									z = s || o <= A;
								(r || (((b && z) || (C && O)) && P >= T[f] - n && M <= T[d] + n)) &&
									(b && z && S.push(s ? A : A - o), C && O && v[A].push(x));
							}
					}
					b && (t === e && S.push(y), (v[y] = S)), p.length ? ((m = u(p, c, w[c])), p.splice(m + 1, 0, y)) : p.push(y);
				}
		...
		b = U.extend({
			initialize: function (t) {
				(this.precision = U.pick(t, 5)), (this.multiplier = Math.pow(10, this.precision));
			},
			number: function (t) {
	...
	var H = new (function () {
			var f = [
					...
					[
						0.10805494870734367, 0.31911236892788974, 0.5152486363581541, 0.6872929048116855, 0.827201315069765, 0.9284348836635735,
						0.9862838086968123,
					],
					[
						0, 0.20119409399743451, 0.3941513470775634, 0.5709721726085388, 0.7244177313601701, 0.8482065834104272, 0.937273392400706,
						0.9879925180204854,
					],
					[
						0.09501250983763744, 0.2816035507792589, 0.45801677765722737, 0.6178762444026438, 0.755404408355003, 0.8656312023878318,
				...
				d = [
					...
					[
						0.2325515532308739, 0.22628318026289723, 0.2078160475368885, 0.17814598076194574, 0.13887351021978725, 0.09212149983772845,
						0.04048400476531588,
					],
					[
						0.2152638534631578, 0.2051984637212956, 0.18553839747793782, 0.15720316715819355, 0.12151857068790319, 0.08015808715976021,
						0.03511946033175186,
					],
					[
						0.2025782419255613, 0.19843148532711158, 0.1861610000155622, 0.16626920581699392, 0.13957067792615432, 0.10715922046717194,
						0.07036604748810812, 0.03075324199611727,
					],
					[
						0.1894506104550685, 0.18260341504492358, 0.16915651939500254, 0.14959598881657674, 0.12462897125553388, 0.09515851168249279,
				...
				return (
					3 * b(u) < l &&
						...
						(u =
							(o = e * e) -
							(h = t * n) +
							(s[0] * s[0] - o + 2 * s[0] * s[1] + s[1] * s[1] - (r[0] * a[0] - h + r[0] * a[1] + r[1] * a[0] + r[1] * a[1])))),
					u
				);
			}
			function M() {
			...
			return {
				...
				integrate: function (t, e, n, i) {
					for (
						var r = f[i - 2], s = d[i - 2], a = 0.5 * (n - e), o = a + e, h = 0, u = (i + 1) >> 1, l = 1 & i ? s[h++] * t(o) : 0;
						h < u;
				...
				findRoot: function (t, e, n, i, r, s, a) {
					for (var o = 0; o < s; o++) {
						...
						n = 0 < h ? ((r = n), l <= i ? 0.5 * (i + r) : l) : ((i = n), r <= l ? 0.5 * (i + r) : l);
					}
					return P(n, i, r);
				},
				solveQuadratic: function (t, e, n, i, r, s) {
					...
					if (b(t) < k) {
						...
						var h,
							...
							l,
							c = p(t, (e *= -0.5), n);
						c && b(c) < I && (h = M(b(t), b(e), b(n))) && (c = p((t *= h), (e *= h), (n *= h))),
							-I <= c && ((u = c < 0 ? 0 : C(c)), (o = 0 === (l = e + (e < 0 ? -u : u)) ? -(a = n / t) : ((a = l / t), n / l)));
					}
					var f = 0,
						d = null == r,
						_ = r - k,
						g = s + k;
					return (
						isFinite(a) && (d || (_ < a && a < g)) && (i[f++] = d ? a : P(a, r, s)),
						o !== a && isFinite(o) && (d || (_ < o && o < g)) && (i[f++] = d ? o : P(o, r, s)),
						f
					);
				},
				solveCubic: function (n, i, r, s, t, e, a) {
					...
					if ((f && ((n *= f), (i *= f), (r *= f), (s *= f)), b(n) < k)) (n = i), (h = r), (u = s), (o = 1 / 0);
						...
						var _ = c / n,
							...
							y = o - p * m;
						if (y !== o) {
							for (; d(y), p * o < p * (y = 0 === l ? o : o - c / l / (1 + I)); );
		...
		Z = U.extend(
			{
				...
				initialize: function (t, e) {
					...
					return (
						'number' == r
							? ((n = 'number' == typeof e), this._set(t, n ? e : t), s && (a = n ? 2 : 1))
							: 'undefined' == r || null === t
				...
				equals: function (t) {
					return (
						this === t || (t && ((this.x === t.x && this.y === t.y) || (Array.isArray(t) && this.x === t[0] && this.y === t[1]))) || !1
					);
				},
				clone: function () {
				...
				setLength: function (t) {
					var e, n;
					this.isZero()
						? ((e = this._angle || 0), this._set(Math.cos(e) * t, Math.sin(e) * t))
						: ((n = t / this.getLength()), H.isZero(n) && this.getAngle(), this._set(this.x * n, this.y * n));
				},
				getAngle: function () {
		...
		W = U.extend(
			{
				...
				statics: {
					min: function (t, e) {
						return new W(Math.min(t.width, e.width), Math.min(t.height, e.height));
					},
					max: function (t, e) {
						return new W(Math.max(t.width, e.width), Math.max(t.height, e.height));
					},
					random: function () {
		...
		M = U.extend(
			{
						...
						: 'undefined' == _ || null === t
							...
							: 1 === d.length &&
								(Array.isArray(t)
									...
									: t.x !== q || t.width !== q
										? (this._set(t.x || 0, t.y || 0, t.width || 0, t.height || 0), (r = 1))
										: t.from === q && t.to === q && (this._set(0, 0, 0, 0), U.readSupported(d, this) && (r = 1))),
						r === q &&
							...
							(r = d.__index));
					var g = d.__filtered;
					return g && (this.__filtered = g), this.__read && (this.__read = r), this;
				},
				set: '#initialize',
				...
				setLeft: function (t) {
					var e;
					this._fw || ((e = t - this.x), (this.width -= 0.5 === this._sx ? 2 * e : e)), (this.x = t), (this._sx = this._fw = 0);
				},
				getTop: function () {
					return this.y;
				},
				setTop: function (t) {
					var e;
					this._fh || ((e = t - this.y), (this.height -= 0.5 === this._sy ? 2 * e : e)), (this.y = t), (this._sy = this._fh = 0);
				},
				getRight: function () {
				...
				setRight: function (t) {
					var e;
					this._fw || ((e = t - this.x), (this.width = 0.5 === this._sx ? 2 * e : e)),
						(this.x = t - this.width),
						(this._sx = 1),
						(this._fw = 0);
				},
				...
				setBottom: function (t) {
					var e;
					this._fh || ((e = t - this.y), (this.height = 0.5 === this._sy ? 2 * e : e)),
				...
				setCenterX: function (t) {
					this._fw || 0.5 === this._sx
						...
						: (this._sx && (this.x += 2 * (t - this.x) * this._sx), (this.width = 2 * (t - this.x))),
						(this._sx = 0.5),
						(this._fw = 0);
				},
				getCenterY: function () {
				...
				setCenterY: function (t) {
					this._fh || 0.5 === this._sy
						...
						: (this._sy && (this.y += 2 * (t - this.y) * this._sy), (this.height = 2 * (t - this.y))),
						(this._sy = 0.5),
						(this._fh = 0);
				},
				...
				contains: function (t) {
					return (t && t.width !== q) || 4 === (Array.isArray(t) ? t : arguments).length
				...
				intersects: function () {
					...
					return (
						t.x + t.width > this.x - e && t.y + t.height > this.y - e && t.x < this.x + this.width + e && t.y < this.y + this.height + e
					);
				},
				intersect: function () {
					var t = M.read(arguments),
		...
		$ = U.extend(
			{
				...
				apply: function (t, e) {
					var n = this._owner;
					return !!n && (n.transform(null, U.pick(t, !0), e), this.isIdentity());
				},
				translate: function () {
					var t = Z.read(arguments),
						e = t.x,
				...
				transform: function (t, e, n) {
					return arguments.length < 3 ? this._transformPoint(Z.read(arguments)) : this._transformCoordinates(t, e, n);
				},
				_transformPoint: function (t, e, n) {
					var i = t.x,
						r = t.y;
					return (e = e || new Z())._set(i * this._a + r * this._c + this._tx, i * this._b + r * this._d + this._ty, n);
				},
				...
				_transformBounds: function (t, e, n) {
					...
					return (e = e || new M())._set(r[0], r[1], s[0] - r[0], s[1] - r[1], n);
				},
				...
				_inverseTransform: function (t, e, n) {
					...
					return (
						c &&
							...
							isFinite(u) &&
							isFinite(l) &&
							((i = t.x - this._tx), (r = t.y - this._ty), (f = (e = e || new Z())._set((i * h - r * o) / c, (r * s - i * a) / c, n))),
						f
					);
				},
				decompose: function () {
					...
					return (
						(i =
							0 !== s || 0 !== a
								? ((t = l(s * s + a * a)), (e = Math.acos(s / t) * (0 < a ? 1 : -1)), (n = [t, u / t]), [c(s * o + a * h, t * t), 0])
								: 0 !== o || 0 !== h
									? ((r = l(o * o + h * h)),
										...
										[0, c(s * o + a * h, r * r)])
									: (n = [(e = 0), 0])),
						{ translation: this.getTranslation(), rotation: e * f, scaling: new Z(n), skewing: new Z(i[0] * f, i[1] * f) }
					);
				},
				getValues: function () {
		...
		G = U.extend({
			...
			initialize: function (t, e, n, i, r) {
				(4 <= arguments.length
					...
					: ((this._px = t.x), (this._py = t.y), (this._vx = e.x), (this._vy = e.y), n)) ||
			...
			statics: {
				intersect: function (t, e, n, i, r, s, a, o, h, u) {
					...
					if (!H.isMachineZero(l)) {
						var c = t - r,
							...
							d = (a * f - o * c) / l,
							_ = (n * f - i * c) / l;
						if (u || (-1e-12 < d && d < 1 + 1e-12 && -1e-12 < _ && _ < 1 + 1e-12))
							return u || (d = d <= 0 ? 0 : 1 <= d ? 1 : d), new Z(t + d * n, e + d * i);
					}
				},
				getSide: function (t, e, n, i, r, s, a, o) {
					...
					var h = r - t,
						u = h * i - (s - e) * n;
					return !o && H.isMachineZero(u) && 0 <= (u = (h * n + h * n) / (n * n + i * i)) && u <= 1 && (u = 0), u < 0 ? -1 : 0 < u ? 1 : 0;
				},
						...
						0 === n
							...
							: 0 === i
								? n < 0
									? s - e
									: e - s
								: ((r - t) * i - (s - e) * n) / (n < i ? i * Math.sqrt(1 + (n * n) / (i * i)) : n * Math.sqrt(1 + (i * i) / (n * n)))
					);
				},
		...
		l = e.extend({
			...
			_changed: function (t, e) {
				var n;
				1 & t && (n = this._view) && ((n._needsUpdate = !0), !n._requested && n._autoUpdate && n.requestUpdate());
				var i,
					r,
					s,
					a = this._changes;
				a && e && ((s = (i = this._changesById)[(r = e._id)]) ? (s.flags |= t) : a.push((i[r] = { item: e, flags: t })));
			},
			clear: function () {
			...
			_insertItem: function (t, e, n) {
				return (
					(e = this.insertLayer(t, e) || (this._activeLayer || this._insertItem(q, new o(D.NO_INSERT), !0)).insertChild(t, e)),
		...
		D = U.extend(
			t,
			{
				statics: {
					extend: function t(e) {
						return (
							e._serializeFields && (e._serializeFields = U.set({}, this.prototype._serializeFields, e._serializeFields)),
							t.base.apply(this, arguments)
						);
					},
					NO_INSERT: { insert: !1 },
			...
			})(),
			{
				...
				_initialize: function (t, e) {
					...
					return (
						...
						i || (n && 0 == t.insert) || (!a.insertItems && (!n || !0 !== t.insert))
							? this._setProject(s)
							: ((n && t.parent) || s)._insertItem(q, this, !0),
						n && t !== D.NO_INSERT && this.set(t, { internal: !0, insert: !0, project: !0, parent: !0 }),
						n
					);
				},
				_serialize: function (i, r) {
					...
					function t(t) {
						for (var e in t) {
							var n = a[e];
							U.equals(n, 'leading' === e ? 1.2 * t.fontSize : t[e]) || (s[e] = U.serialize(n, i, 'data' !== e, r));
						}
					}
					return t(this._serializeFields), this instanceof S || t(this._style._defaults), [this._class, s];
				},
				_changed: function (t) {
					var e = this._symbol,
						n = this._parent || e,
				...
				setName: function (t) {
					...
					var e,
						n,
						i = this._getOwner();
					t && i && ((e = i._children), ((n = i._namedChildren)[t] = n[t] || []).push(this), t in e || (e[t] = this)),
						(this._name = t || q),
						this._changed(256);
				},
				getStyle: function () {
			...
			),
			{
				...
				setSelection: function (t) {
					var e;
					t !== this._selection && ((this._selection = t), (e = this._project) && (e._updateSelection(this), this._changed(257)));
				},
				...
				setClipMask: function (t) {
					this._clipMask != (t = !!t) &&
						((this._clipMask = t) && (this.setFillColor(null), this.setStrokeColor(null)),
						this._changed(257),
				...
				setPivot: function () {
					(this._pivot = Z.read(arguments, 0, { clone: !0, readNull: !0 })), (this._position = q);
				},
			},
			U.each(
				...
				},
				{
					...
					setBounds: function () {
						...
						i.translate(r),
							(t.width == e.width && t.height == e.height) ||
								(n.isInvertible() || (n.set(n._backup || new $().translate(n.getTranslation())), (e = this.getBounds())),
								i.scale(0 !== e.width ? t.width / e.width : 0, 0 !== e.height ? t.height / e.height : 0)),
							(r = e.getCenter()),
							i.translate(-r.x, -r.y),
							this.transform(i);
					},
					_getBounds: function (t, e) {
						...
						return n && n.length ? (D._updateBoundsCache(this, e.cacheItem), D._getBounds(n, t, e)) : new M();
					},
					...
					_getCachedBounds: function (t, e, n) {
						...
						var i = e.internal && !n,
							...
							o = this._bounds;
						if ((D._updateBoundsCache(this._parent || this._symbol, r), a && o && a in o))
							return { rect: (h = o[a]).rect.clone(), nonscaling: h.nonscaling };
						var h,
						...
						return (
							a && (o || (this._bounds = o = {}), (h = o[a] = { rect: l.clone(), nonscaling: f, internal: i })),
							{ rect: l, nonscaling: f }
						);
					},
					...
					statics: {
						_updateBoundsCache: function (t, e) {
							...
							t &&
								e &&
								((n = e._id),
								(i = t._boundsCache = t._boundsCache || { ids: {}, list: [] }).ids[n] || (i.list.push(e), (i.ids[n] = e)));
						},
						_clearBoundsCache: function (t) {
							...
							if (e) {
								...
								for (var n = 0, i = e.list, r = i.length; n < r; n++) {
									var s = i[n];
									s !== t && ((s._bounds = s._position = q), s._boundsCache && D._clearBoundsCache(s));
								}
							}
						},
						_getBounds: function (t, e, n) {
							...
							for (var a = 0, o = t.length; a < o; a++) {
								...
								f._visible &&
									!f.isEmpty(!0) &&
									((u = (h = f._getCachedBounds(e && e.appended(f._matrix), n, !0)).rect),
									(l = Math.min(u.x, l)),
									(i = Math.min(u.y, i)),
							...
							return { rect: isFinite(l) ? new M(l, i, c - l, r - i) : new M(), nonscaling: s };
						},
					},
				},
			),
				...
				setScaling: function () {
					...
					s &&
						...
						(i = H.isZero)(s.x) || i(s.y)
							? (n.translate(e.translation), t && n.rotate(t), n.scale(a.x, a.y), this._matrix.set(n))
			...
			},
			{
				...
				_asPathItem: function () {
					return new Q.Rectangle({ rectangle: this.getInternalBounds(), matrix: this._matrix, insert: !1 });
				},
				intersects: function (t, e) {
					return t instanceof D && 0 < this._asPathItem().getIntersections(t._asPathItem(), null, e, !0).length;
				},
			},
			new (function () {
				function t() {
				...
				return l.inject({ hitTest: t, hitTestAll: e, _hitTest: n }), { hitTest: t, hitTestAll: e, _hitTestChildren: n };
			})(),
			{
				_hitTest: function (i, e, t) {
					...
					var n = this._matrix,
						...
						a = (e._tolerancePadding = new W(Q._getStrokePadding(s, n._shiftless().invert())));
					if (
						!(i = n._inverseTransform(i)) ||
						(!this._children && !this.getBounds({ internal: !0, stroke: !0, handle: !0 }).expand(a.multiply(2))._containsPoint(i))
					)
						return null;
					var o,
						h,
					...
					function d(t, e) {
						...
						if (i.subtract(n).divide(a).length <= 1) return new O(t, c, { name: e ? U.hyphenate(e) : t, point: n });
					}
					var _ = e.position,
						g = e.center,
						p = e.bounds;
					if (u && this._parent && (_ || g || p)) {
						if (((g || p) && (o = this.getInternalBounds()), !(h = (_ && d('position')) || (g && d('center', 'Center'))) && p))
							for (
								var v = [
										'TopLeft',
										'TopRight',
					...
					return (
						(h =
							...
							(u && f(this._hitTestSelf(i, e, r, this.getStrokeScaling() ? null : r._shiftless().invert()))) ||
							null) &&
							h.point &&
				...
				matches: function (t, e) {
					...
					var r = /^(empty|editable)$/.test(t) ? this['is' + U.capitalize(t)]() : 'type' === t ? U.hyphenate(this._class) : this[t];
					if ('class' === t) {
				...
				statics: {
					_getItems: function t(e, n, i, r, s) {
						...
						r ||
							...
							a && (n = U.filter({}, n, { recursive: !0, inside: !0, overlapping: !0 })));
						var u,
							l = e._children,
							c = r.items;
						i = (u = r.rect) && (i || new $());
			...
			},
			{
				...
				_removeNamed: function () {
					...
					s &&
						((t = s._children),
						-1 !== (r = (i = (e = s._namedChildren)[(n = this._name)]) ? i.indexOf(this) : -1) &&
							(t[n] == this && delete t[n], i.splice(r, 1), i.length ? (t[n] = i[0]) : delete e[n]));
				},
				_remove: function (t, e) {
					...
					return (
						...
						!!n &&
							...
							null != r &&
								(i._activeLayer === this && (i._activeLayer = this.getNextSibling() || this.getPreviousSibling()),
				...
				removeChildren: function (t, e) {
					...
					for (var n = U.splice(this._children, null, t, e - t), i = n.length - 1; 0 <= i; i--) n[i]._remove(!0, !1);
				...
				},
				{
					...
					transform: function (t, e, n) {
						var i,
							...
							o = this._matrix,
							h = t && !t.isIdentity(),
							u = (n && this._canApplyMatrix) || (this._applyMatrix && (h || !o.isIdentity() || (e && this._children)));
						if (!h && !u) return this;
						h &&
							(!t.isInvertible() && o.isInvertible() && (o._backup = o.getValues()),
							o.prepend(t, !0),
						...
						if (f && f.skewing.isZero() && f.rotation % 90 == 0) {
							for (var d in l) {
								var _,
									g = l[d];
								g.nonscaling ? delete l[d] : (!u && g.internal) || ((_ = g.rect), t._transformBounds(_, _));
							}
							var p = (this._bounds = l)[this._getBoundsCacheKey(this._boundsOptions || {})];
							p && (this._position = this._getPositionFromBounds(p.rect));
						} else h && c && this._pivot && (this._position = t._transformPoint(c, c));
						return this;
					},
					...
					f.hasFill() && (t.fillStyle = f.getFillColor().toCanvasStyle(t, d)),
						f.hasStroke() &&
							...
							at.support.nativeDash &&
								...
								a &&
									a.length &&
									('setLineDash' in t ? (t.setLineDash(a), (t.lineDashOffset = o)) : ((t.mozDash = a), (t.mozDashOffset = o))))),
						f.hasShadow() &&
							((h = e.pixelRatio || 1),
							(l = (u = n._shiftless().prepend(new $().scale(h, h))).transform(new Z(f.getShadowBlur(), 0))),
				...
				draw: function (t, e, n) {
					...
					if (this._visible && 0 !== this._opacity) {
						...
						if (a.isInvertible()) {
							...
							t.save();
							var v,
								m = n ? n.appended(s) : this._canScaleStroke && !this.getStrokeScaling(!0) && r,
								y = !_ && e.clipItem,
								w = !m || y;
							_ ? ((t.globalAlpha = c), d && (t.globalCompositeOperation = l)) : w && t.translate(-h.x, -h.y),
								w && (_ ? s : r).applyToContext(t),
								y && e.clipItem.draw(t, e.extend({ clip: !0 })),
								m && (t.setTransform(g, 0, 0, g, 0, 0), (v = e.offset) && t.translate(-v.x, -v.y)),
								this._draw(t, e, r, m),
								t.restore(),
								i.pop(),
								e.clip && !e.dontFinish && t.clip(this.getFillRule()),
								_ || (x.process(l, t, o, c, h.subtract(u).multiply(g)), it.release(t), (e.offset = u));
						}
					}
				},
						...
						if (((t.strokeStyle = t.fillStyle = l ? l.toCanvasStyle(t) : '#009dec'), a && this._drawSelected(t, c, i), h)) {
							...
							for (
								...
								var b = m[x],
									C = b[0],
									S = b[1];
								t.moveTo(p + C * y, v + S * y), t.lineTo(p + C * w, v + S * w), t.stroke();
							}
						}
						if (o) {
				...
				},
				{
					removeOn: function (t) {
						for (var e in t) {
							...
							t[e] &&
								((n = 'mouse' + e),
								((r = (i = this._project)._removeSets = i._removeSets || {})[n] = r[n] || {}),
								(r[n][this._id] = this));
						}
						return this;
					},
		...
		S = D.extend({
			...
			_getBounds: function t(e, n) {
				...
				return i ? i._getCachedBounds(i._matrix.prepended(e), U.set({}, n, { stroke: !1 })) : t.base.call(this, e, n);
			},
		...
		k = D.extend(
			{
				...
				toPath: function (t) {
					var e = new Q[U.capitalize(this._type)]({ center: new Z(), size: this._size, radius: this._radius, insert: !1 });
					return e.copyAttributes(this), at.settings.applyMatrix && e.setApplyMatrix(!0), (t !== q && !t) || e.insertAbove(this), e;
				},
				toShape: '#clone',
				_asPathItem: function () {
				...
				_draw: function (t, e, n, i) {
					...
					(y || w || x) &&
						...
						x ||
							(!y && !w) ||
							(this._setStyles(t, e, n), y && (t.fill(m.getFillRule()), (t.shadowColor = 'rgba(0,0,0,0)')), w && t.stroke());
				},
				_canComposite: function () {
				...
				_getBounds: function (t, e) {
					...
					return t && (n = t._transformBounds(n)), r ? n.expand(Q._getStrokePadding(r, this._getStrokeMatrix(t, e))) : n;
				},
			},
			new (function () {
				function m(t, e, n) {
				...
				return {
					_contains: function t(e) {
						if ('rectangle' !== this._type) return e.divide(this.size).getLength() <= 0.5;
						var n = m(this, e);
					...
					_hitTestSelf: function t(e, n, i, r) {
						...
						return (
							(p || v) &&
								...
								(h = n._tolerancePadding.add(Q._getStrokePadding(o, !g.getStrokeScaling() && r))),
								(_ =
									'rectangle' === s
										? (l = m(this, e, (u = h.multiply(2))))
											? y(e.subtract(l.point), a, h, l.quadrant)
											: ((f = (c = new M(this._size).setCenter(0, 0)).expand(u)),
												(d = c.expand(u.negate())),
												f._containsPoint(e) && !d._containsPoint(e))
										: y(e, a, h))),
							_ ? new O(p ? 'stroke' : 'fill', this) : t.base.apply(this, arguments)
						);
					},
				};
			})(),
			{
				statics: new (function () {
					function i(t, e, n, i, r) {
						...
						return (s._type = t), (s._size = n), (s._radius = i), s._initialize(U.getNamed(r), e), s;
					}
					return {
						Circle: function () {
							var t = arguments,
						...
						_readEllipse: function (t) {
							...
							return (
								(i = U.hasNamed(t, 'radius')
									...
									: ((n = (e = M.readNamed(t, 'rectangle')).getCenter(!0)), e.getSize(!0).divide(2))),
								{ center: n, radius: i }
							);
						},
					};
		...
		I = D.extend(
			{
				...
				initialize: function (t, e) {
					...
					this._initialize(t, e !== q && Z.read(arguments)) ||
						((r = 'string' == (i = typeof t) ? T.getElementById(t) : 'object' == i ? t : null) &&
							r !== D.NO_INSERT &&
							(r.getContext || null != r.naturalHeight ? (n = r) : r && ((s = W.read(arguments)).isZero() || (n = it.getCanvas(s)))),
				...
				copyContent: function (t) {
					var e,
						n = t._image,
						i = t._canvas;
					n ? this._setImage(n) : i && ((e = it.getCanvas(t._size)).getContext('2d').drawImage(i, 0, 0), this._setImage(e)),
				...
				setSize: function () {
					...
					e.equals(this._size) ||
						(0 < e.width && 0 < e.height
							...
							: (this._canvas && it.release(this._canvas), (this._size = e.clone())));
				},
				getWidth: function () {
				...
				_setImage: function (t) {
					this._canvas && it.release(this._canvas),
						t && t.getContext
							...
							: ((this._image = t), (this._canvas = null), (this._loaded = !!(t && t.src && t.complete))),
						(this._size = new W(t ? t.naturalWidth || t.width : 0, t ? t.naturalHeight || t.height : 0)),
						(this._context = null),
						this._changed(1033);
				},
				getCanvas: function () {
				...
				getAverageColor: function (t) {
					...
					if (
						(t
							? t instanceof z
								? (e = (n = t).getBounds())
								: 'object' == typeof t && ('width' in t ? (e = new M(t)) : 'x' in t && (e = new M(t.x - 0.5, t.y - 0.5, 1, 1)))
							: (e = this.getBounds()),
						!e)
					)
						return null;
					var i = Math.min(e.width, 32),
						...
						s = I._sampleContext;
					s ? s.clearRect(0, 0, 33, 33) : (s = I._sampleContext = it.getContext(new W(32))), s.save();
					var a = new $().scale(i / e.width, r / e.height).translate(-e.x, -e.y);
					a.applyToContext(s), n && n.draw(s, new U({ clip: !0, matrices: [a] })), this._matrix.applyToContext(s);
					var o = this.getElement(),
						h = this._size;
					o && s.drawImage(o, -h.width / 2, -h.height / 2), s.restore();
					for (
						var u = s.getImageData(0.5, 0.5, Math.ceil(i), Math.ceil(r)).data, l = [0, 0, 0], c = 0, f = 0, d = u.length;
						f < d;
						f += 4
					) {
						var _ = u[f + 3];
		...
		a = D.extend({
			...
			initialize: function (t, e) {
				this._initialize(t, e !== q && Z.read(arguments, 1)) || this.setDefinition(t instanceof P ? t : new P(t));
			},
			_equals: function (t) {
		...
		P = U.extend({
			...
			initialize: function (t, e) {
				(this._id = u.get()), (this.project = at.project), t && this.setItem(t, e);
			},
			_serialize: function (t, e) {
		...
		J = U.extend({
			...
			initialize: function (t, e, n, i, r, s) {
				...
				0 < l &&
					(null == t || 'object' == typeof t
						? (u =
								1 === l && t && 'point' in t
									? ((a = t.point), (o = t.handleIn), (h = t.handleOut), t.selection)
									: ((a = t), (o = e), (h = n), i))
						: ((a = [t, e]), (o = n !== q ? [n, i] : null), (h = r !== q ? [r, s] : null))),
					new d(a, this, '_point'),
				...
				r &&
					...
					e &&
						((t && t !== this._point && t !== this._handleIn) ||
							...
							i._changed(),
						(t && t !== this._point && t !== this._handleOut) || !(i = e[n]) || i._changed()),
					r._changed(41));
			},
			getPoint: function () {
				return this._point;
			...
			smooth: function (t, e, n) {
				var i,
					...
					g = f.getDistance(d);
				if (o && 'catmull-rom' !== o) {
					if ('geometric' !== o) throw new Error("Smoothing method '" + o + "' not supported.");
					u &&
						l &&
						((i = c.subtract(d)),
						(s = ((r = h === q ? 0.4 : h) * _) / (_ + g)),
					...
					!e &&
						...
						(v = 3 * x * (x + y)),
						this.setHandleIn(
							0 !== v ? new Z((b * c._x + p * f._x - w * d._x) / v - f._x, (b * c._y + p * f._y - w * d._y) / v - f._y) : new Z(),
						)),
						!n &&
							l &&
							((p = 2 * w + 3 * y * x + b),
							(v = 3 * y * (y + x)),
							this.setHandleOut(
								0 !== v ? new Z((w * d._x + p * f._x - b * c._x) / v - f._x, (w * d._y + p * f._y - b * c._y) / v - f._y) : new Z(),
							));
				}
			},
		...
		d = Z.extend({
			initialize: function (t, e, n) {
				...
				t
					? (i = t[0]) !== q
						? (r = t[1])
						: ((i = (a = t).x) === q && (i = (a = Z.read(arguments)).x), (r = a.y), (s = a.selected))
					: (i = r = 0),
					(this._x = i),
					(this._y = r),
		...
		X = U.extend(
			{
				...
				getPoints: function () {
					for (var t = this.getValues(), e = [], n = 0; n < 8; n += 2) e.push(new Z(t[n], t[n + 1]));
					return e;
				},
			},
			{
				getLength: function () {
					return null == this._length && (this._length = X.getLength(this.getValues(), 0, 1)), this._length;
				},
				getArea: function () {
				...
				divideAtTime: function (t, e) {
					...
					return (
						1e-8 <= t &&
							...
							(o = this._segment2),
							(h = this._path),
							s && (a._handleOut._set(i[2] - i[0], i[3] - i[1]), o._handleIn._set(r[4] - r[6], r[5] - r[7])),
							(u = i[6]),
							(l = i[7]),
							(c = new J(new Z(u, l), s && new Z(i[4] - u, i[5] - l), s && new Z(r[2] - u, r[3] - l))),
							(f = h ? (h.insert(a._index + 1, c), this.getNext()) : ((this._segment2 = c), this._changed(), new X(c, o)))),
						f
					);
				},
				splitAt: function (t) {
				...
				statics: {
								...
								: ((n = 3 * (f - d) - c + _),
									...
									(a = H.solveQuadratic(n, i, r, s, 1e-8, 1 - 1e-8))
										? (s.sort(),
											...
											(h = X.subdivide(t, o)),
											u.push(h[0]),
											1 < a && ((o = (s[1] - o) / (1 - o)), (h = X.subdivide(h[1], o)), u.push(h[0])),
											u.push(h[1]))
										: u.push(t)),
							u
						);
					...
					solveCubic: function (t, e, n, i, r, s) {
						...
						return (
							(u < n && f < n && l < n && c < n) ||
								(n < u && n < f && n < l && n < c) ||
								((h = f - u - (a = 3 * (l - u)) - (o = 3 * (c - l) - a)), (d = H.solveCubic(h, o, a, u - n, i, r, s))),
							d
						);
					},
					getTimeOf: function (t, e) {
						...
						if (null === (e.isClose(n, 1e-12) ? 0 : e.isClose(i, 1e-12) ? 1 : null))
							for (var r = [e.x, e.y], s = [], a = 0; a < 2; a++)
								for (var o = X.solveCubic(t, a, r[a], s, 0, 1), h = 0; h < o; h++) {
									var u = s[h];
					...
					getNearestTime: function (n, i) {
						if (X.isStraight(n)) {
							...
							return o < 1e-12 ? 0 : 0.999999999999 < o ? 1 : X.getTimeOf(n, new Z(t + o * r, e + o * s));
						}
						var h = 1 / 0,
							u = 0;
						function l(t) {
						...
						if (t < l || e < l || n < l || i < l || c < t || c < e || c < n || c < i)
							if (e < t != e < i && n < t != n < i) u(t, 0), u(i, 0);
								...
								for (var p = 0; p < g; p++) {
									var v = h[p],
										m = 1 - v;
									1e-8 <= v && v <= 1 - 1e-8 && u(m * m * m * t + 3 * m * m * v * e + 3 * m * v * v * n + v * v * v * i, s);
								}
							}
					},
				},
				...
				function (t) {
					this[t] = function () {
						return (
							...
							(this._bounds[t] || (this._bounds[t] = Q[t]([this._segment1, this._segment2], !1, this._path))).clone()
						);
					};
				},
				{},
					...
					(this[t] = function (t) {
						...
						(this.statics[t] = function (t, e) {
							var n = t[0],
								...
								r = t[6],
								s = t[7];
							return a(new Z(n, i), new Z(t[2] - n, t[3] - i), new Z(t[4] - r, t[5] - s), new Z(r, s), e);
						});
				},
				{
					statics: {},
							...
							: (0,
								(p =
									e < 1e-8
										...
										: 1 - 1e-8 < e
											? ((g = 3 * (l - h)), 3 * (c - u))
											: ((g = (3 * y * e + 2 * m) * e + v), (3 * b * e + 2 * x) * e + w)),
								i &&
									(0 === g && 0 === p && (e < 1e-8 || 1 - 1e-8 < e) && ((g = h - a), (p = u - o)),
									(d = Math.sqrt(g * g + p * p)) && ((g /= d), (p /= d))),
								3 === n &&
									((h = 6 * y * e + 2 * m),
									(u = 6 * b * e + 2 * x),
									(g = 0 !== (_ = Math.pow(g * g + p * p, 1.5)) ? (g * u - p * h) / _ : 0),
									(p = 0))),
					...
					statics: {
						classify: function (t) {
							...
							function v(t, e, n) {
								var i = e !== q,
									...
									s = i && 0 < n && n < 1;
								return (
									!i || ((r || s) && ('loop' !== t || (r && s))) || (r = s = !(t = 'arch')),
									{ type: t, roots: r || s ? (r && s ? (e < n ? [e, n] : [n, e]) : [r ? e : n]) : null }
								);
							}
							if (((c *= _), (l *= _), g((f *= _)))) return g(c) ? v(g(l) ? 'line' : 'quadratic') : v(p, l / (3 * c));
							var m = 3 * c * c - 4 * f * l;
						...
						getLength: function (t, e, n, i) {
							if ((e === q && (e = 0), n === q && (n = 1), X.isStraight(t))) {
								var r = t;
								n < 1 && ((r = X.subdivide(r, n)[0]), (e /= n)), 0 < e && (r = X.subdivide(r, e)[1]);
								var s = r[6] - r[0],
									a = r[7] - r[1];
			...
			new (function () {
				...
				function R(t, e, n, i, r, s, a, o, h, u, l, c, f) {
								...
								l = n - (t + 2 * i) / 3;
							{
								...
								r =
									u * l < 0
										...
										: [2 <= (c = u / l) ? [s, a, h] : c <= 0.5 ? [s, o, h] : [s, a, o, h], [s, h]];
							}
					...
					return (
						Math.max(f - c, F - B) < 1e-9
							? ((E = (B + F) / 2), (N = (c + f) / 2), j(r, s, a ? i : n, a ? N : E, a ? n : i, a ? E : N))
							: ((t = X.getPart(t, d, _)),
								(z = f - c),
								(h =
									0.8 < _ - d
										? z < F - B
											? ((E = (B + F) / 2),
												(h = R(e, (L = X.subdivide(t, 0.5))[0], i, n, r, s, !a, o, h, c, f, B, E)),
												R(e, L[1], i, n, r, s, !a, o, h, c, f, E, F))
											: ((N = (c + f) / 2),
												(h = R((L = X.subdivide(e, 0.5))[0], t, i, n, r, s, !a, o, h, c, N, B, F)),
				...
				function C(t, e, n, i, r) {
					...
					for (var o = Math.atan2(-r, i), h = Math.sin(o), u = Math.cos(o), l = [], c = [], f = 0; f < 8; f += 2) {
						var d = t[f] - e,
							_ = t[f + 1] - n;
								...
								((_
									...
									: f || d
										? function (t, e, n, i, r, s, a) {
												for (var o = e[0], h = e[1], u = C(t, o, h, e[6] - o, e[7] - h), l = 0, c = u.length; l < c; l++) {
													var f = u[l],
														d = X.getPoint(t, f),
														_ = X.getTimeOf(e, d);
													null !== _ && j(r, s, a ? i : n, a ? _ : f, a ? n : i, a ? f : _);
												}
											}
										: R)(g ? e : t, g ? t : e, g ? i : n, g ? n : i, r, s, g, 0, 0, 0, 1, 0, 1),
								!_ || r.length === p)
							)
								for (l = 0; l < 4; l++) {
									var v = l >> 1,
				...
				function S(t, e) {
					...
					var i = Math.abs,
						...
						_ = l[6] - f,
						g = l[7] - d;
					if (r(f, d, _, g, c[0], c[1], !0) < s && r(f, d, _, g, c[6], c[7], !0) < s)
						!h &&
					...
					if (a ^ o) return null;
					for (var p, v, m = [t, e], y = [], w = 0; w < 4 && y.length < 2; w++) {
						var x,
							b = 1 & w,
							C = 1 ^ b,
							S = w >> 1,
						...
						if (
							(null != k &&
								((x = b ? [S, k] : [k, S]), (!y.length || (1e-8 < i(x[0] - y[0][0]) && 1e-8 < i(x[1] - y[0][1]))) && y.push(x)),
							2 < w && !y.length)
						)
							break;
					}
				...
				return {
					...
					statics: {
						...
						getIntersections: function (t, e, n, i, r, s) {
							var a = !e;
							a && (e = t);
							for (var o = t.length, h = e.length, u = new Array(o), l = a ? u : new Array(h), c = [], f = 0; f < o; f++)
								u[f] = t[f].getValues(i);
							if (!a) for (f = 0; f < h; f++) l[f] = e[f].getValues(r);
							for (var d = V.findCurveBoundsCollisions(u, l, 1e-7), _ = 0; _ < o; _++) {
								var g = t[_],
									p = u[_];
								a && b(p, g, c, n);
								var v = d[_];
						...
						getTimesWithTangent: function (t, e) {
							...
							return (
								Math.abs(k) < H.CURVETIME_EPSILON
									? 0 == (k = y * b - w * x) || (0 <= (n = -(y * S - w * C) / k) && n <= 1 && I.push(n))
									: ((r = x * m - b * v),
										0 <=
											(i =
												(x * x - 4 * y * C) * m * m +
		...
		K = U.extend(
			{
				...
				_setSegment: function (t) {
					var e = t.getCurve();
					e ? this._setCurve(e) : (this._setPath(t._path), (this._segment1 = t), (this._segment2 = null)),
						(this._segment = t),
					...
					return (
						n ||
							...
							0 === (e = this.getTime())
								...
								: 1 === e
									? (n = t._segment2)
									: null != e && (n = t.getPartLength(0, e) < t.getPartLength(e, 1) ? t._segment1 : t._segment2),
							(this._segment = n)),
						n
					);
				},
				...
				getCurveOffset: function () {
					var t,
						...
						n = this._curveOffset;
					return (
						null == n && ((t = this.getCurve()), (e = this.getTime()), (this._curveOffset = n = null != e && t && t.getPartLength(0, e))),
						n
					);
				},
					...
					return (
						!u &&
							...
							(r = n._path) === i._path &&
								...
								(h = !e && t._intersection),
								(u = (a < 1e-7 || (r && s(r.getLength() - a) < 1e-7)) && ((!o && !h) || (o && h && o.equals(h, !0)))))),
						u
					);
				},
				toString: function () {
				...
				isCrossing: function () {
					...
					if ((r < e && (o = o.getNext()), r < n && (u = u.getNext()), !(h && o && l && u))) return !1;
					var c = [];
					function f(t, e) {
						var n = t.getValues(),
		...
		z = D.extend({
			...
			statics: {
				create: function (t) {
					var e, n, i, r;
					return (
						U.isPlainObject(t) ? ((n = t.segments), (e = t.pathData)) : Array.isArray(t) ? (n = t) : 'string' == typeof t && (e = t),
						n ? (r = (i = n[0]) && Array.isArray(i[0])) : e && (r = 1 < (e.match(/m/gi) || []).length || /z\s*\S+/i.test(e)),
						new (r ? Y : Q)(t)
					);
				},
			},
			...
			setPathData: function (t) {
				...
				for (var u = 0, l = i && i.length; u < l; u++) {
					...
					switch (('z' !== e || /[mz]/.test(_) || this.moveTo(s), _)) {
						...
						case 's':
							for (v = 0; v < g; v += 4)
								this.cubicCurveTo(/[cs]/.test(e) ? s.multiply(2).subtract(n) : s, (n = h(v)), (s = h(v + 2))), (e = _);
							break;
						case 'q':
						...
						case 't':
							for (v = 0; v < g; v += 2)
								this.quadraticCurveTo((n = /[qt]/.test(e) ? s.multiply(2).subtract(n) : s), (s = h(v))), (e = _);
							break;
						case 'a':
							for (v = 0; v < g; v += 7) this.arcTo((s = h(v + 5)), new W(+c[v], +c[v + 1]), +c[v + 2], +c[v + 4], +c[v + 3]);
							break;
						case 'z':
			...
			getIntersections: function (t, e, n, i) {
				...
				return r || this.getBounds(s).intersects(t.getBounds(a), 1e-12)
					? X.getIntersections(this.getCurves(), !r && t.getCurves(), e, s, a, i)
					: [];
			},
			...
			getNearestLocation: function () {
				for (var t = Z.read(arguments), e = this.getCurves(), n = 1 / 0, i = null, r = 0, s = e.length; r < s; r++) {
			...
			compare: function (t) {
				...
				if (t) {
					var n = this._children || [this],
						...
						o = 0;
					e = !0;
					for (var h = V.findItemBoundsCollisions(n, i, H.GEOMETRIC_EPSILON), u = r - 1; 0 <= u && e; u--) {
						var l = n[u],
							e = !1,
							c = h[u];
						if (c) for (var f = c.length - 1; 0 <= f && !e; f--) l.compare(i[c[f]]) && (a[c[f]] || ((a[c[f]] = !0), o++), (e = !0));
					}
					e = e && o === s;
				}
				return e;
		...
		Q = z.extend(
			{
				...
				initialize: function (t) {
					...
					var e = arguments,
						n = Array.isArray(t) ? ('object' == typeof t[0] ? t : e) : !t || t.size !== q || (t.x === q && t.point === q) ? null : e;
					n && 0 < n.length
						? this.setSegments(n)
						: ((this._curves = q), (this._segmentSelection = 0), n || 'string' != typeof t || (this.setPathData(t), (t = null))),
				...
				setSegments: function (t) {
					...
					(this._segments.length = 0),
						...
						(this._curves = q),
						i && ('boolean' == typeof (e = t[i - 1]) && (this.setClosed(e), i--), this._add(J.readList(t, 0, {}, i))),
				...
				getCurves: function () {
					var t = this._curves,
						e = this._segments;
					if (!t)
						for (var n = this._countCurves(), t = (this._curves = new Array(n)), i = 0; i < n; i++)
				...
				setClosed: function (t) {
					...
					this._closed != (t = !!t) &&
						...
						this._curves &&
							...
							t && (this._curves[e - 1] = new X(this, this._segments[e - 1], this._segments[0]))),
						this._changed(41));
				},
			},
			{
				...
				getPathData: function (r, t) {
								...
								: ((u = _[2]),
									...
									u === s && l === a && c === o && f === h
										? e ||
											((n = s - o),
											(i = a - h),
											p.push(0 == n ? 'v' + d.number(i) : 0 == i ? 'h' + d.number(n) : 'l' + d.pair(n, i)))
										: p.push('c' + d.pair(c - o, f - h) + ' ' + d.pair(u - o, l - h) + ' ' + d.pair(s - o, a - h))),
							(o = s),
							(h = a),
							(c = _[4]),
							(f = _[5]);
					...
					return this._closed && 0 < n && (i(e[0], !0), p.push('z')), p.join('');
				},
				isEmpty: function () {
				...
				_adjustCurves: function (t, e) {
					for (var n, i = this._segments, r = this._curves, s = t; s < e; s++)
						((n = r[s])._path = this), (n._segment1 = i[s]), (n._segment2 = i[s + 1] || i[0]), n._changed();
					(n = r[this._closed && !t ? i.length - 1 : t - 1]) && ((n._segment2 = i[t] || i[0]), n._changed()),
				...
				add: function (t) {
					var e = arguments;
					return 1 < e.length && 'number' != typeof t ? this._add(J.readList(e)) : this._add([J.read(e)])[0];
				},
				insert: function (t, e) {
					var n = arguments;
					return 2 < n.length && 'number' != typeof e ? this._add(J.readList(n, 1), t) : this._add([J.read(n, 1)], t)[0];
				},
				addSegment: function () {
				...
				removeSegments: function (t, e, n) {
					...
					if (r) {
						for (var c = 0 < t && e === s + (this._closed ? 1 : 0) ? t - 1 : t, h = (r = r.splice(c, o)).length - 1; 0 <= h; h--)
							r[h]._path = null;
				...
				getArea: function () {
					if (null == (n = this._area)) {
						for (var t = this._segments, e = this._closed, n = 0, i = 0, r = t.length; i < r; i++) {
							var s = i + 1 === r;
							n += X.getArea(X.getValues(t[i], t[s ? 0 : i + 1], null, s && !e));
						}
						this._area = n;
					}
					return n;
				...
				splitAt: function (t) {
					...
					if (0 <= n && n < r.length) {
						...
						return (
							this._closed ? (this.setClosed(!1), (s = this)) : ((s = new Q(D.NO_INSERT)).insertAbove(this), s.copyAttributes(this)),
							s._add(a, 0),
							this.addSegment(a[0]),
							s
						);
				...
				split: function (t, e) {
					var n,
						i = e === q ? t : (n = this.getCurves()[t]) && n.getLocationAtTime(e);
				...
				join: function (t, e) {
					...
					if (t && t !== this) {
						...
						r && r._point.isClose(o._point, n)
							...
							: ((a = this.getFirstSegment()) && a._point.isClose(o._point, n) && t.reverse(),
								(s = t.getLastSegment()),
								a && a._point.isClose(s._point, n)
									? (a.setHandleIn(s._handleIn), this._add(i.slice(0, i.length - 1), 0))
									: this._add(i.slice())),
				...
				flatten: function (t) {
					for (var e = new m(this, t || 0.25, 256, !0).parts, n = e.length, i = [], r = 0; r < n; r++)
						i.push(new J(e[r].curve.slice(0, 2)));
					!this._closed && 0 < n && i.push(new J(e[n - 1].curve.slice(6))), this.setSegments(i);
				},
				simplify: function (t) {
				...
				smooth: function (t) {
					...
					var h,
						...
						l = o(e.from, 0),
						c = o(e.to, s - 1);
					if ((c < l && (a ? (l -= s) : ((h = l), (l = c), (c = h))), /^(?:asymmetric|continuous)$/.test(n))) {
						var f = 'asymmetric' === n,
							d = Math.min,
							_ = c - l + 1,
							g = _ - 1,
							...
							m = p,
							y = [];
						if ((a || ((v = d(1, l)), (m = d(1, s - c - 1))), (g += v + m) <= 1)) return;
						for (var w = 0, x = l - v; w <= g; w++, x++) y[w] = i[(x < 0 ? x + s : x) % s]._point;
						for (
							var b = g - 1, C = [(L = y[0]._x + 2 * y[1]._x)], S = [(N = y[0]._y + 2 * y[1]._y)], k = [(E = 2)], I = [], P = [], w = 1;
							w < g;
							w++
						)
							var M = w < b,
						...
						for (w = g - 2; 0 <= w; w--) (I[w] = (C[w] - I[w + 1]) / k[w]), (P[w] = (S[w] - P[w + 1]) / k[w]);
						(I[g] = (3 * y[g]._x - I[b]) / 2), (P[g] = (3 * y[g]._y - P[b]) / 2);
						for (var w = v, B = g - m, x = l; w <= B; w++, x++) {
							var F = i[x < 0 ? x + s : x],
								j = F._point,
								R = I[w] - j._x,
								D = P[w] - j._y;
							(u || w < B) && F.setHandleOut(R, D), (u || v < w) && F.setHandleIn(-R, -D);
						}
					} else for (w = l; w <= c; w++) i[w < 0 ? w + s : w].smooth(e, !u && w === l, !u && w === c);
				},
				toShape: function (t) {
					...
					if (
						...
						a._handleOut.isZero() &&
							...
							s._handleOut.isZero() &&
							o._handleIn.isZero() &&
							s._point.subtract(a._point).isOrthogonal(o._point.subtract(s._point)))
							? ((e = k.Rectangle), (n = new W(c(0, 3), c(0, 1))), (r = u[1]._point.add(u[2]._point).divide(2)))
							: 8 === u.length && l(0) && l(2) && l(4) && l(6) && h(1, 5) && h(3, 7)
								? ((e = k.Rectangle),
									(i = (n = new W(c(1, 6), c(0, 3))).subtract(new W(c(0, 7), c(1, 2))).divide(2)),
				...
				compare: function t(e) {
					...
					for (var _, g, p = Math.abs, d = u[a]; h && d; ) {
						if ((g = X.getOverlaps(h, d)))
							if (p(g[0][0] - c) < 1e-8) {
								1 === (c = g[1][0]) && ((h = ++l < r ? n[l].getValues() : null), (c = 0));
								var v = g[0][1];
								if (p(v - o) < 1e-8) {
									if (
										((_ = _ || [a, v]), 1 === (o = g[1][1]) && (++a >= s && (a = 0), (d = u[a] || i[a].getValues()), (o = 0)), !h)
									)
										return _[0] === a && _[1] === o;
									continue;
								}
				...
				_hitTestSelf: function (i, r, t, s) {
					var a,
						...
						y = r.fill && f.hasFill(),
						w = r.curves,
						x = m ? f.getStrokeWidth() / 2 : (y && 0 < r.tolerance) || w ? 0 : null;
					function b(t, e) {
					...
					function C(t, e, n) {
						if (!r.selected || e.isSelected()) {
							var i = t._point;
							if ((e !== i && (e = e.add(i)), b(e, v))) return new O(n, c, { segment: t, point: e });
						}
					}
					function S(t, e) {
						return (
							((e || r.segments) && C(t, t._point, 'segment')) ||
							(!e && r.handles && (C(t, t._handleIn, 'handle-in') || C(t, t._handleOut, 'handle-out')))
						);
					}
					function k(t) {
						u.add(t);
					...
					function I(t) {
						...
						return 'round' === (n ? a : o)
							...
							: ((u = new Q({ internal: !0, closed: !0 })),
								...
								!u.isEmpty() && (u.contains(i) || ((e = u.getNearestLocation(i)) && b(e.getPoint(), p))));
					}
					if (
						(null !== x &&
							(0 < x
								? ((a = f.getStrokeJoin()), (o = f.getStrokeCap()), (h = f.getMiterLimit()), (v = v.add(Q._getStrokePadding(x, s))))
								: (a = o = 'round')),
						!r.ends || r.segments || g)
					) {
						if (r.segments || r.handles) for (var P = 0; P < _; P++) if ((e = S(d[P]))) return e;
					} else if ((e = S(d[0], !0) || S(d[_ - 1], !0))) return e;
					if (
						null !== x &&
						((l = this.getNearestLocation(i)) &&
							(0 === (n = l.getTime()) || (1 === n && 1 < _) ? I(l.getSegment()) || (l = null) : b(l.getPoint(), v) || (l = null)),
						!l && 'miter' === a && 1 < _)
					)
						for (P = 0; P < _; P++) {
							var M = d[P];
					...
					return (!l && y && this._contains(i)) || (l && !m && !w)
						? new O('fill', this)
						: l
							? new O(m ? 'stroke' : 'curve', this, { location: l, point: l.getPoint() })
							: null;
				},
			},
			U.each(
				...
				},
				{
					beans: !1,
					getLocationOf: function () {
						for (var t = Z.read(arguments), e = this.getCurves(), n = 0, i = e.length; n < i; n++) {
					...
					getLocationAt: function (t) {
						if ('number' == typeof t) {
							...
							if (0 < e.length && t <= this.getLength()) return new K(e[e.length - 1], 1);
			...
			new (function () {
				function v(i, t, r) {
					...
					function g(t) {
						var e, n;
						(a = r ? (t._transformCoordinates(r, d), (s = d[0]), d[1]) : ((e = t._point), (s = e._x), e._y)),
							_
								? (i.moveTo(s, a), (_ = !1))
								: ((l = r ? ((u = d[2]), d[3]) : ((n = t._handleIn), (u = s + n._x), a + n._y)),
									u === s && l === a && c === o && f === h ? i.lineTo(s, a) : i.bezierCurveTo(c, f, u, l, s, a)),
							(o = s),
							(h = a),
							(f = r ? ((c = d[4]), d[5]) : ((n = t._handleOut), (c = o + n._x), h + n._y));
					}
				...
				return {
					_draw: function (t, e, n, i) {
						...
						if (
							(r || t.beginPath(),
							(o || (h && !l) || s) && (v(t, this, i), this._closed && t.closePath()),
							!s && (o || h) && (this._setStyles(t, e, n), o && (t.fill(a.getFillRule()), (t.shadowColor = 'rgba(0,0,0,0)')), h))
						) {
							if (l) {
								r || t.beginPath();
								for (var f, d = new m(this, 0.25, 32, !1, i), _ = d.length, g = -a.getDashOffset(), p = 0; 0 < g; )
									g -= c(p--) + c(p--);
					...
					_drawSelected: function (t, e) {
						t.beginPath(),
							...
							(function (i, t, e, n) {
								if (!(n <= 0))
									for (var r, s, a = n / 2, o = n - 2, h = a - 1, u = new Array(6), l = 0, c = t.length; l < c; l++) {
										var f,
											d = t[l],
											_ = d._selection;
										d._transformCoordinates(e, u),
											...
											0 < o &&
												!(1 & _) &&
												((f = i.fillStyle), (i.fillStyle = '#ffffff'), i.fillRect(r - h, s - h, o, o), (i.fillStyle = f));
									}
								function g(t) {
									var e = u[t],
										n = u[t + 1];
				...
				return {
					...
					cubicCurveTo: function () {
						var t = arguments,
							...
							i = Z.read(t),
							r = V(this);
						r.setHandleOut(e.subtract(r._point)), this._add([new J(i, n.subtract(i))]);
					},
					...
					arcTo: function () {
						var t,
							...
							h = Z.read(i),
							u = U.peek(i);
						if ('boolean' == typeof (_ = U.pick(u, !0))) var l = (p = o.add(h).divide(2)).add(p.subtract(o).rotate(_ ? -90 : 90));
							...
							if (
								(1 < k && ((x = (y *= k) * y), (b = (w *= k) * w)),
								r((k = (x * b - x * S - b * C) / (x * S + b * C))) < 1e-12 && (k = 0),
								k < 0)
							)
							...
							(I = new Z((y * m) / w, (-w * v) / y)
								...
								.rotate(d)
								.add(p)),
								(t = (e = (n = new $().translate(I).rotate(d).scale(y, w))._inverseTransform(o)).getDirectedAngle(
						...
						if (t) {
							for (
								...
								j < E &&
									...
									n ? ((D = n._transformPoint(e)), (q = n._transformPoint(e.add(q)).subtract(D))) : (D = I.add(e))),
									j
					...
					arcBy: function () {
						var t = arguments,
							...
							n = e.add(Z.read(t)),
							i = U.pick(U.peek(t), !0);
						'boolean' == typeof i ? this.arcTo(n, i) : this.arcTo(n, e.add(Z.read(t)));
					},
				...
				statics: {
					getBounds: function (t, e, n, i, r, s) {
						...
						function f(t) {
							...
							for (var e = 0; e < 2; e++) X._addBounds(h[e], h[e + 4], o[e + 2], o[e], e, s ? s[e] : 0, u, l, c);
							var n = h;
							(h = o), (o = n);
						}
					...
					getStrokeBounds: function (t, e, n, i, r) {
						...
						function m(t, e) {
							'round' === e || t.isSmooth() ? v(t) : Q._addBevelJoin(t, e, c, _, i, h, p);
						}
						function y(t, e) {
					...
					_addBevelJoin: function (t, e, n, i, r, s, a, o) {
						...
						(_ < 0 || 180 <= _) && ((f = f.negate()), (d = d.negate())),
							...
							a(c.add(f)),
							'miter' !== e ||
								((h = new G(c.add(f), new Z(-f.y, f.x), !0).intersect(new G(c.add(d), new Z(-d.y, d.x), !0), !0)) &&
									c.getDistance(h) <= i * n &&
									a(h)),
							a(c.add(d));
					},
					...
					getHandleBounds: function (t, e, n, i, r) {
						...
						r.stroke &&
							...
							'square' === l.getStrokeCap() && (u = Math.max(u, h * Math.SQRT2)),
							(s = Q._getStrokePadding(h, o)),
							(a = Q._getStrokePadding(u, o)));
						for (var c = new Array(6), f = 1 / 0, d = -f, _ = f, g = d, p = 0, v = t.length; p < v; p++) {
							...
							for (var m = 0; m < 6; m += 2) {
								var y = m ? s : a,
									...
									I = C - x,
									P = C + x;
								S < f && (f = S), d < k && (d = k), I < _ && (_ = I), g < P && (g = P);
							}
						}
		...
		statics: new (function () {
			...
			function i(t, e, n) {
				for (var i = new Array(4), r = 0; r < 4; r++) {
					var s = a[r];
					i[r] = new J(s._point.multiply(e).add(t), s._handleIn.multiply(e), s._handleOut.multiply(e));
				}
				return f(i, !0, n);
			}
			return {
				Line: function () {
					var t = arguments;
					return f([new J(Z.readNamed(t, 'from')), new J(Z.readNamed(t, 'to'))], !1, t);
				},
				Circle: function () {
					var t = arguments,
						e = Z.readNamed(t, 'center'),
	...
	var Y = z.extend(
		{
				...
				for (var s = n.length - 1; 0 <= s; s--) {
					...
					i !== n || a instanceof Q || (i = U.slice(i)),
						Array.isArray(a)
							...
							: a instanceof Y && (i.splice.apply(i, [s, 1].concat(a.removeChildren())), a.remove());
				}
			...
			reduce: function t(e) {
				...
				return i.length ? t.base.call(this) : ((n = new Q(D.NO_INSERT)).copyAttributes(this), n.insertAbove(this), this.remove(), n);
			},
			isClosed: function () {
			...
			getCurves: function () {
				for (var t = this._children, e = [], n = 0, i = t.length; n < i; n++) U.push(e, t[n].getCurves());
				return e;
			},
			getFirstCurve: function () {
				var t = this.getFirstChild();
			...
			_hitTestChildren: function t(e, n, i) {
				return t.base.call(this, e, n.class === Q || 'path' === n.type ? n : U.set({}, n, { fill: !1 }), i);
			},
			_draw: function (t, e, n, i) {
				var r = this._children;
				if (r.length) {
					...
					e.clip ||
						(this._setStyles(t, e, n),
						(s = this._style).hasFill() && (t.fill(s.getFillRule()), (t.shadowColor = 'rgba(0,0,0,0)')),
	...
	z.inject(
		new (function () {
			var E = Math.min,
				L = Math.max,
				N = Math.abs,
				S = { unite: { 1: !0, 2: !0 }, intersect: { 2: !0 }, subtract: { 1: !0 }, exclude: { 1: !0, '-1': !0 } };
			function k(t) {
			...
			function I(t, e) {
				...
				if (e) {
					for (var i = k(n), r = 0, s = i.length; r < s; r++) {
						(t = i[r])._closed ||
							t.isEmpty() ||
							(t.closePath(1e-12), t.getFirstSegment().setHandleIn(0, 0), t.getLastSegment().setHandleOut(0, 0));
					}
			...
			function P(t, e, n, i, r) {
				...
				return (
					...
					(r && 0 == r.insert) || s.insertAbove(i && n.isSibling(i) && n.getIndex() < i.getIndex() ? i : n),
			...
			function n(t, e, n, i) {
				if (i && (0 == i.trace || i.stroke) && /^(subtract|intersect)$/.test(n)) return A(t, e, n);
				var r = I(t, !0),
					s = e && t !== e && I(e, !0),
					a = S[n];
				...
				function d(t) {
					for (var e = 0, n = t.length; e < n; e++) {
						var i = t[e];
						U.push(c, i._segments), U.push(f, i.getCurves()), (i._overlapsOnly = !0);
					}
				}
				function _(t) {
					for (var e = [], n = 0, i = t && t.length; n < i; n++) e.push(f[t[n]]);
					return e;
				}
				if (h.length) {
					d(u), l && d(l);
					for (var g = new Array(f.length), p = 0, v = f.length; p < v; p++) g[p] = f[p].getValues();
					for (var m = V.findCurveBoundsCollisions(g, g, 0, !0), y = {}, p = 0; p < f.length; p++) {
						var w = f[p],
							x = w._path._id;
						(y[x] = y[x] || {})[w.getIndex()] = { hor: _(m[p].hor), ver: _(m[p].ver) };
					}
					for (p = 0, v = h.length; p < v; p++) j(h[p]._segment, r, s, y, a);
					for (p = 0, v = c.length; p < v; p++) {
						var b = c[p],
							C = b._intersection;
						b._winding || j(b, r, s, y, a), (C && C._overlap) || (b._path._overlapsOnly = !1);
					}
					o = R(c, a);
				} else
			...
			function B(t, e, n) {
				...
				for (c = t.length - 1; 0 <= c; c--) {
					...
					if (
						((f = _._curve) &&
							(f !== r ? ((o = !f.hasHandles() || (u && u[l(f)])), (i = []), (s = null), (r = f)) : 1e-8 <= s && (g /= s)),
						v)
					)
						i && i.push(_);
					else {
					...
					if (b <= L(e, n, i, r) && b >= E(e, n, i, r))
						for (
							var s,
								...
								h = t[y + 4],
								u = t[y + 6],
								l = S > L(a, o, h, u) || k < E(a, o, h, u) ? [t] : X.getMonoCurves(t, g),
								c = 0,
								f = l.length;
							c < f;
							c++
									...
									if (!(b < E(e, n) || b > L(e, n))) {
										...
										if (e !== n) {
											var o =
													b === e
														? 0
														: b !== n && !(S > L(i, r, s, a) || k < E(i, r, s, a)) && 0 < X.solveCubic(t, w, b, T, 0, 1)
															? T[0]
															: 1,
												h = 0 === o ? i : 1 === o ? a : X.getPoint(t, o)[g ? 'y' : 'x'],
												u = n < e ? 1 : -1,
												l = m[w] > m[w + 6] ? 1 : -1,
												c = m[y + 6];
											return (
												b !== e
													? (h < S ? (I += u) : k < h ? (P += u) : (M = !0), x - C < h && h < x + C && (A /= 2))
													: (u != l
															? i < S
																? (I += u)
																: k < i && (P += u)
															: i != c &&
																(c < k && k < h ? ((P += u), (M = !0)) : S < c && h < S && ((I += u), (M = !0))),
														(A /= 4)),
												(m = t),
												!v && S < h && h < k && 0 === X.getTangent(t, o)[g ? 'x' : 'y'] && F(d, _, !g, p, !0)
											);
										}
										((i < k && S < a) || (a < k && S < i)) && (M = !0);
									}
				...
				for (var o = 0, h = e.length; o < h; o++) {
					...
					if (
						!(
							(o && e[o - 1]._path === c) ||
							((m = null),
							c._closed || ((t = X.getValues(c.getLastCurve().getSegment2(), l.getSegment1(), null, !p))[w] !== t[w + 6] && (m = t)),
							m)
						)
					) {
						m = f;
					...
					if (o + 1 === h || e[o + 1]._path !== c) {
						if (t && (u = a(t))) return u;
						!M || I || P || (I = P = c.isClockwise(p) ^ g ? 1 : -1), (i += I), (r += P), (I = P = 0), (M = M && !(s = !0)), (t = null);
					}
				}
				return (i = N(i)), (r = N(r)), { winding: L(i, r), windingL: i, windingR: r, quality: A, onPath: s };
			}
			function j(t, e, n, i, r) {
				var s = [],
					...
					o = 0;
				do {
					(p = t.getCurve()) && ((c = p.getLength()), s.push({ segment: t, curve: p, length: c }), (o += c)), (t = t.getNext());
				} while (t && !t._intersection && t !== a);
				for (var h = [0.5, 0.25, 0.75], u = { winding: 0, quality: -1 }, l = 0; l < h.length && u.quality < 0.5; l++)
					for (var c = o * h[l], f = 0, d = s.length; f < d; f++) {
						...
						if (c <= g) {
							...
							(C = C || F(x, i[v._id][p.getIndex()], b, !0)).quality > u.quality && (u = C);
							break;
						}
						c -= g;
					}
			...
			function R(t, n) {
				...
				function l(t) {
					...
					return !(
						!t ||
						t._visited ||
						(n && (!n[(e = t._winding || {}).winding] || (n.unite && 2 === e.winding && e.windingL && e.windingR)))
					);
				}
				function c(t) {
					if (t) for (var e = 0, n = u.length; e < n; e++) if (t === u[e]) return !0;
					return !1;
				}
				function i(t) {
				...
				for (var r = 0, s = t.length; r < s; r++) {
					...
					for (
						...
						f.compare(d) && (f.getArea() && e.push(f.clone(!1)), i(f), i(d), (g = !1)));
						g;
								...
								function n(t, e) {
									for (; t && t !== e; ) {
										var n,
											...
											s = r && r._path;
										s &&
											((i = (n = r.getNext() || s.getFirstSegment())._intersection),
											r !== a && (c(r) || c(n) || (n && l(r) && (l(n) || (i && l(i._segment))))) && h.push(r),
											o && u.push(r)),
											(t = t._next);
									}
								}
						...
						if (
							(C && a && (y.push(a), (a = null)),
							a || (C && x.push(_), (a = { start: p._segments.length, crossings: x, visited: (o = []), handleIn: h })),
							C && (_ = b),
							!l(_))
						) {
							...
							for (
								o.length = 0;
								((_ = a && a.crossings.shift()) && _._path) || ((_ = null), (a = y.pop()) && ((o = a.visited), (h = a.handleIn))),
									a && !l(_);
					...
					v && (m && (p.getFirstSegment().setHandleIn(h), p.setClosed(m)), 0 !== p.getArea() && e.push(p));
				}
				return e;
			}
			return {
				...
				divide: function (t, e) {
					return e && (0 == e.trace || e.stroke) ? A(this, t, 'divide') : P([this.subtract(t, e), this.intersect(t, e)], !0, this, t, e);
				},
				resolveCrossings: function () {
					...
					if (i)
						for (
							...
							n(f, l) &&
								...
								f === c || f.getCurve().hasLength() || (d._handleIn.set(f._handleIn), f.remove()));
						}
					r &&
						(B(
							s,
					...
					return (
						1 < g && t
							...
							: 1 !== g || t || (e[0] !== this && this.setSegments(e[0].removeSegments()), (_ = this)),
						_ || ((_ = new Y(D.NO_INSERT)).addChildren(e), (_ = _.reduce()).copyAttributes(this), this.replaceWith(_)),
						_
					);
				},
					...
					if (!this.contains(t)) {
						for (var e = this.getCurves(), n = t.y, i = [], r = [], s = 0, a = e.length; s < a; s++) {
							...
							if (n >= E(h, u, l, c) && n <= L(h, u, l, c))
								for (var f = X.getMonoCurves(o), d = 0, _ = f.length; d < _; d++) {
									var g,
										p = f[d],
										v = p[1],
										m = p[7];
	...
	var m = U.extend(
			{
					...
					function o(t, e) {
						...
						r.push(n),
							(function t(e, n, i, r) {
								{
									var s, a, o, h, u;
									!(_ < r - i) || (c && X.isStraight(e)) || X.isFlatEnough(e, l || 0.25)
										? ((s = e[6] - e[0]),
											(a = e[7] - e[1]),
											0 < (o = Math.sqrt(s * s + a * a)) && ((d += o), f.push({ offset: d, curve: e, index: n, time: r })))
										: ((h = X.subdivide(e, 0.5)), (u = (i + r) / 2), t(h[0], n, i, u), t(h[1], n, u, r));
								}
							})(n, t._index, 0, 1);
					}
					for (var h = 1, u = s.length; h < u; h++) o(a, (n = s[h])), (a = n);
					t._closed && o(n || a, s[0]), (this.curves = r), (this.parts = f), (this.length = d), (this.index = 0);
				},
				_get: function (t) {
				...
				drawPart: function (t, e, n) {
					for (var i = this._get(e), r = this._get(n), s = i.index, a = r.index; s <= a; s++) {
						var o = X.getPart(this.curves[s], s === i.index ? i.time : 0, s === r.index ? r.time : 1);
			...
			fit: function (t) {
				...
				return (
					0 < n &&
						((i = [new J(e[0])]),
						1 < n &&
							(this.fitCubic(i, t, 0, n - 1, e[1].subtract(e[0]), e[n - 2].subtract(e[n - 1])), this.closed && (i.shift(), i.pop()))),
					i
				);
			},
			...
			generateBezier: function (t, e, n, i, r) {
				for (
					...
					var d = n[c],
						...
						w = i.normalize(v),
						x = r.normalize(m),
						b = a[t + c].subtract(o.multiply(p + v)).subtract(h.multiply(m + y));
				...
				1e-12 < s(M)
					? ((C = u[0][0] * l[1] - u[1][0] * l[0]), (S = (l[0] * u[1][1] - l[1] * u[0][1]) / M), (k = C / M))
					: ((I = u[0][0] + u[0][1]), (P = u[1][0] + u[1][1]), (S = k = 1e-12 < s(I) ? l[0] / I : 1e-12 < s(P) ? l[1] / P : 0));
				var A,
					T,
					O,
					z = h.getDistance(o),
			...
			new (function () {
				...
				return U.each(
											...
											'gradient' === s
												? 'gradient' === t
													? function (t) {
															...
															return (
																e !== (t = L.read(Array.isArray(t) ? t : arguments, 0, { readNull: !0 })) &&
																	(e && e._removeOwner(this), t && t._addOwner(this)),
																t
															);
														}
													: function () {
															return Z.read(arguments, 0, { readNull: 'highlight' === t, clone: !0 });
														}
												: function (t) {
														return null == t || isNaN(t) ? 0 : +t;
													});
									(this['get' + n] = function () {
										return this._type === s || (i && /^hs[bl]$/.test(this._type)) ? this._components[e] : this._convert(s)[e];
									}),
										(this['set' + n] = function (t) {
											this._type === s ||
												(i && /^hs[bl]$/.test(this._type)) ||
												((this._components = this._convert(s)), (this._properties = y[s]), (this._type = s)),
					...
					},
					{
						...
						initialize: function t(e) {
							...
							if (
								('string' === a &&
									...
									((c = e),
									(e = i[1]),
									Array.isArray(e) ? ((u = e), (h = i[2])) : (r && (s = 1), (i = U.slice(i, 1)), (a = typeof e))),
								!u)
							) {
								if ((n = 'number' === a ? i : 'object' === a && null != e.length ? e : null)) {
									c = c || (3 <= n.length ? 'rgb' : 'gray');
									var o = y[c].length,
										h = n[o];
									r && (s += n === arguments ? o + (null != h ? 1 : 0) : 1), n.length > o && (n = U.slice(n, 0, o));
								} else if ('string' === a) {
									var u,
										l = (function (t) {
											var e =
													t.match(/^#([\da-f]{2})([\da-f]{2})([\da-f]{2})([\da-f]{2})?$/i) ||
											...
											if (e)
												...
												for (var o = 'hsl' === n, s = 0, h = Math.min(r.length, 4); s < h; s++) {
													...
													o
														? 0 === s
															? ((u = l.match(/([a-z]*)$/)[1]),
																(a *= { turn: 360, rad: 180 / Math.PI, grad: 0.9 }[u] || 1))
															: s < 3 && (a /= 100)
												...
												r = (f =
													f ||
													(A
														? (m || ((m = it.getContext(1, 1)).globalCompositeOperation = 'copy'),
									...
									if (e.constructor === t) {
										if (((c = e._type), (u = e._components.slice()), (h = e._alpha), 'gradient' === c))
							...
							return (this._components = u), (this._properties = y[this._type]), (this._alpha = h), r && (this.__read = s), this;
						},
						set: '#initialize',
						_serialize: function (t, e) {
							var n = this.getComponents();
							return U.serialize(/^(gray|rgb)$/.test(this._type) ? n : [this._type].concat(n), t, !0, e);
						},
						_changed: function () {
						...
						_convert: function (t) {
							...
							return this._type === t
								...
								: (e = n[this._type + '-' + t])
									...
									: n['rgb-' + t].apply(this, n[this._type + '-rgb'].apply(this, this._components));
						},
						convert: function (t) {
						...
						toString: function () {
							for (var t = this._properties, e = [], n = 'gradient' === this._type, i = b.instance, r = 0, s = t.length; r < s; r++) {
						...
						toCanvasStyle: function (t, e) {
							...
							var n,
								...
								c = a[3],
								f = e && e.inverted();
							f && ((u = f._transformPoint(u)), (l = f._transformPoint(l)), (c = c && f._transformPoint(c))),
								(s = o._radial
									? ((n = l.getDistance(u)),
										!c || ((i = c.subtract(u)).getLength() > n && (c = u.add(i.normalize(n - 0.1)))),
										(r = c || u),
							...
							for (var d = 0, _ = h.length; d < _; d++) {
								var g = h[d],
									p = g._offset;
								s.addColorStop(null == p ? d / (_ - 1) : p, g._color.toCanvasStyle());
							}
							...
							_setOwner: function (t, e, n) {
								return (
									t &&
										...
										!t._owner ^ !e && ((t._owner = e || null), (t._setter = n || null))),
									t
								);
							},
						},
				...
				return U.each(
					...
					function (a, t) {
						this[t] = function (t) {
							...
							return new E(e, i, null != this._alpha ? a(this._alpha, t.getAlpha()) : null);
						};
					},
					{},
				);
		...
		L = U.extend({
			...
			_removeOwner: function (t) {
				...
				-1 != e && (this._owners.splice(e, 1), this._owners.length || (this._owners = q));
			},
			clone: function () {
			...
			setStops: function (t) {
				...
				for (n = 0, i = (e = this._stops = N.readList(t, 0, { clone: !0 })).length; n < i; n++) e[n]._owner = this;
				this._changed();
			},
			getRadial: function () {
				return this._radial;
		...
		N = U.extend({
			...
			initialize: function (t, e) {
				...
				'object' == typeof t &&
					...
					(Array.isArray(t) && 'number' != typeof t[0]
						? ((n = t[0]), (i = t[1]))
						: ('color' in t || 'offset' in t || 'rampPoint' in t) && ((n = t.color), (i = t.offset || t.rampPoint || 0))),
					this.setColor(n),
					this.setOffset(i);
			},
			clone: function () {
			...
			setColor: function () {
				E._setOwner(this._color, null), (this._color = E._setOwner(E.read(arguments, 0), this, 'setColor')), this._changed();
			},
			equals: function (t) {
		...
		g = U.extend(
			new (function () {
				var i = {
					...
					r = U.set({}, i, { fontFamily: 'sans-serif', fontWeight: 'normal', fontSize: 12, leading: null, justification: 'left' }),
					...
					h = {
						...
						initialize: function (t, e, n) {
							(this._values = {}),
								...
								(this._defaults = !e || e instanceof S ? r : e instanceof _ ? s : i),
								t && this.set(t);
						},
					};
				return (
					U.each(r, function (t, u) {
						...
						(h[f] = function (t) {
							...
							if (r) for (var s = 0, a = i.length; s < a; s++) i[s]._style[f](t);
							('selectedColor' !== u && r) ||
								!(u in this._defaults) ||
								((e = this._values[u]) !== t &&
									(l &&
										(e && (E._setOwner(e, null), (e._canvasStyle = null)),
										t && t.constructor === E && (t = E._setOwner(t, n, r && f))),
									(this._values[u] = t),
									n && n._changed(o || 129)));
						}),
							(h[d] = function (t) {
								...
								if (s && !t)
									...
									u in this._defaults &&
										((e = this._values[u]) === q
											...
											: !(n = l ? E : c ? Z : null) ||
												(e && e.constructor === n) ||
												(this._values[u] = e = n.read([e], 0, { readNull: !0, clone: !0 })));
					...
					U.each({ Font: 'FontFamily', WindingRule: 'FillRule' }, function (t, e) {
						var n = 'get' + e,
							i = 'set' + e;
			...
			})(),
			{
				set: function (t) {
					...
					if (i)
						for (var r in i) {
							r in this._defaults && ((e = i[r]), (this[r] = e && n && e.clone ? e.clone() : e));
						}
				},
				equals: function (t) {
					function e(t, e, n) {
						...
						for (var a in i) {
							var o = i[a],
								h = r[a];
							if (!((n && a in r) || U.equals(o, h === q ? s[a] : h))) return !1;
						}
						return !0;
					}
		...
		B = new (function () {
			...
			return {
				...
				getBounds: function (t, e) {
					...
					return (
						e ||
							((o += (a = i.defaultView).pageXOffset || s.scrollLeft || r.scrollLeft),
				...
				if (t)
					for (var n in e)
						for (var i = e[n], r = n.split(/[\s,]+/g), s = 0, a = r.length; s < a; s++) {
							var o = r[s],
								h = t === T && ('touchstart' === o || 'touchmove' === o) && { passive: !1 };
							t.addEventListener(o, i, h);
						}
			},
			remove: function (t, e) {
				if (t)
					for (var n in e) for (var i = e[n], r = n.split(/[\s,]+/g), s = 0, a = r.length; s < a; s++) t.removeEventListener(r[s], i, !1);
			},
			getPoint: function (t) {
				var e = t.targetTouches ? (t.targetTouches.length ? t.targetTouches[0] : t.changedTouches[0]) : t;
				return new Z(e.pageX || e.clientX + T.documentElement.scrollLeft, e.pageY || e.clientY + T.documentElement.scrollTop);
			},
	...
	var j = U.extend(
			t,
			{
				...
				initialize: function t(e, n) {
					...
					A && n
						? ((this._id = n.getAttribute('id')),
							null == this._id && n.setAttribute('id', (this._id = 'paper-view-' + t._id++)),
						...
						(this._element = n),
						this._pixelRatio || (this._pixelRatio = (A && A.devicePixelRatio) || 1),
				...
				remove: function () {
					...
					j._focused === this && (j._focused = null), j._views.splice(j._views.indexOf(this), 1), delete j._viewsById[this._id];
					var t = this._project;
					return (
						...
						F.requestAnimationFrame(function () {
							...
							(e._requested = !1),
								e._animate &&
									(e.requestUpdate(),
									(t = e._element),
									(B.getPrefixed(T, 'hidden') && 'true' !== c.getAttribute(t, 'keepalive')) || !B.isInView(t) || e._handleFrame()),
				...
				_handleFrame: function () {
					...
					(this._last = t),
						this.emit('frame', new U({ delta: e, time: (this._time += e), count: this._count++ })),
						this._stats && this._stats.update();
				},
				_animateItem: function (t, e) {
					var n = this._frameItems;
					e
						? ((n[t._id] = { item: t, time: 0, count: 0 }), 1 == ++this._frameItemCount && this.on('frame', this._handleFrameItems))
						: (delete n[t._id], 0 == --this._frameItemCount && this.off('frame', this._handleFrameItems));
				},
				_handleFrameItems: function (t) {
					for (var e in this._frameItems) {
						var n = this._frameItems[e];
						n.item.emit('frame', new U(t, { time: (n.time += t.delta), count: n.count++ }));
					}
				},
				_changed: function () {
				...
				getBounds: function () {
					return this._bounds || (this._bounds = this._matrix.inverted()._transformBounds(new M(new Z(), this._viewSize))), this._bounds;
				},
				getSize: function () {
			...
			},
			{
				statics: {
					...
					_id: 0,
					create: function (t, e) {
						return T && 'string' == typeof e && (e = T.getElementById(e)), new (A ? r : j)(t, e);
					},
				},
			},
			new (function () {
				if (A) {
					...
					a.pointerEnabled || a.msPointerEnabled
						...
						: ((t = 'touchstart'),
							...
							('ontouchstart' in A && a.userAgent.match(/mobile|tablet|ip(ad|hone|od)|android|silk/i)) ||
					...
					(o[t] = function (t) {
						...
						(h[e] = function (t) {
							...
							s ||
								((e = c(t))
									? n !== e && (n && d(n, t), (i = i || n), (n = j._focused = r = e))
									: r && r === n && (i && !i.isInserted() && (i = null), (n = j._focused = i), (i = null), f())),
								n && d(n, t);
						}),
						(h[t] = function () {
							s = !0;
					...
					return {
						...
						_handleMouseEvent: function (t, e, n) {
							...
							s && g && h('mousedrag') && (t = 'mousedrag'), (n = n || this.getEventPoint(e));
							...
							if (
								((d[t.substr(5)] = !0),
								r && c !== y && (y && P(y, null, 'mouseleave', e, n), c && P(c, null, 'mouseenter', e, n), (y = c)),
								I ^ u && (P(this, null, u ? 'mouseenter' : 'mouseleave', e, n), (f = !0)),
								(!u && !d.drag) || n.equals(v) || (M(this, c, s ? t : 'mousemove', e, n, v), (f = !0)),
								(I = u),
								(d.down && u) || (d.up && p))
							) {
								if ((M(this, c, t, e, n, p), d.down)) {
									if (((C = c === x && Date.now() - b < 300), (m = x = c), !k && c)) {
									...
									d.up &&
										(k || c !== m || ((b = Date.now()), M(this, c, C ? 'doubleclick' : 'click', e, n, p), (C = !1)),
										(m = w = null));
								f = !(I = !1);
							}
							(v = n),
								f && a && (S = a._handleMouseEvent(t, e, n, d) || S),
								!1 !== e.cancelable && ((S && !d.move) || (d.down && h('mouseup'))) && e.preventDefault();
						},
						_handleKeyEvent: function (e, n, i, r) {
							var s,
								...
								t = a.tool;
							function o(t) {
								t.responds(e) && ((at = a), t.emit(e, (s = s || new R(e, n, i, r))));
							}
						...
						statics: {
							...
							_resetState: function () {
								(g = s = S = I = !1), (i = r = p = v = m = y = w = x = b = C = null);
							},
						},
					};
				}
						...
						!(function t(e, n) {
							if (e.responds(n)) {
								if (
									...
									e.emit(n, h) && ((S = !0), h.prevented && (k = !0), h.stopped))
								)
									return (u = !0);
							} else {
								var i = l[n];
				...
				function M(t, e, n, i, r, s) {
					return (
						...
						(k = S = !1),
						(w && P(w, null, n, i, r, s)) ||
							(e && e !== w && !e.isDescendant(w) && P(e, null, 'mousedrag' === n ? 'mousemove' : n, i, r, s, w)) ||
							P(t, w || e || t, n, i, r, s)
					);
				}
			})(),
		...
		r = j.extend({
			...
			initialize: function (t, e) {
				if (!(e instanceof A.HTMLCanvasElement)) {
					...
					if (n.isZero()) throw new Error('Cannot create CanvasView with the provided argument: ' + U.slice(arguments, 1));
					e = it.getCanvas(n);
				}
				var i,
					r,
				...
				s.save(),
					...
					/^off|false$/.test(c.getAttribute(e, 'hidpi')) ||
						((i = A.devicePixelRatio || 1), (r = B.getPrefixed(s, 'backingStorePixelRatio') || 1), (this._pixelRatio = i / r)),
					j.call(this, t, e),
					(this._needsUpdate = !0);
			},
			remove: function t() {
			...
			_setElementSize: function t(e, n) {
				...
				t.base.call(this, e * a, n * a),
					1 !== a &&
						((i = this._element),
						(r = this._context),
						c.hasAttribute(i, 'resize') || (((s = i.style).width = e + 'px'), (s.height = n + 'px')),
						r.restore(),
						r.save(),
						r.scale(a, a));
			},
			...
			getPixelSize: function t(e) {
				...
				return (
					s && s.firefox
						...
						: ((r = (i = this._context).font), (i.font = e + ' serif'), (n = parseFloat(i.font)), (i.font = r)),
					n
				);
			},
			getTextWidth: function (t, e) {
		...
		v = new (function () {
			var h,
				r,
				n = { '\t': 'tab', ' ': 'space', '\b': 'backspace', '\x7f': 'delete', Spacebar: 'space', Del: 'delete', Win: 'meta', Esc: 'escape' },
				i = { tab: '\t', space: ' ', enter: '\r' },
				u = {},
				l = {},
				c = new U({ shift: !1, control: !1, alt: !1, meta: !1, capsLock: !1, space: !1 }).inject({
					option: {
						get: function () {
							return this.alt;
						},
			...
			function f(t, e, n, i) {
				var r,
					s = j._focused;
				if (((u[e] = t) ? (l[e] = n) : delete l[e], 1 < e.length && (r = U.camelize(e)) in c)) {
					c[r] = t;
					var a = at && at.agent;
					if ('meta' === r && a && a.mac)
						if (t) h = {};
			...
			return (
				F.add(T, {
					keydown: function (t) {
						var e = s(t),
							n = at && at.agent;
						1 < e.length || (n && n.chrome && (t.altKey || (n.mac && t.metaKey) || (!n.mac && t.ctrlKey)))
					...
					keypress: function (t) {
						...
						r &&
							((e = s(t)),
							(i = 32 <= (n = t.charCode) ? String.fromCharCode(n) : 1 < e.length ? '' : e),
							e !== r && (e = i.toLowerCase()),
							f(!0, e, i, t),
							(r = null));
					},
				...
				if (this.running) {
					...
					for (var n = this.easing(e), i = this._keys, r = 0, s = i && i.length; r < s; r++) {
						var a = i[r],
							o = t(this._from[a]),
							h = t(this._to[a]),
							u = o && h && o.__add && h.__add ? h.__subtract(o).__multiply(n).__add(o) : (h - o) * n + o;
						this._setProperty(this._parsedKeys[a], u);
					}
					this.responds('update') && this.emit('update', new U({ progress: e, factor: n })),
		...
		it = (U.exports.CanvasProvider = {
			...
			getCanvas: function (t, e) {
				...
				'object' == typeof t && ((e = t.height), (t = t.width)),
					this.canvases.length ? (n = this.canvases.pop()) : ((n = T.createElement('canvas')), (i = !1));
		...
		x = new (function () {
			...
			function e(t, e, n, i) {
				var r,
					...
					h = l(C, S, k),
					u = c(C, S, k);
				h < 0 && ((C = i + ((C - i) * i) / (r = i - h)), (S = i + ((S - i) * i) / r), (k = i + ((k - i) * i) / r)),
					255 < u && ((C = i + ((C - i) * (s = 255 - i)) / (a = u - i)), (S = i + ((S - i) * s) / a), (k = i + ((k - i) * s) / a));
			}
			function n(t, e, n) {
			...
			function i(t, e, n, i) {
				var r = [t, e, n],
					s = c(t, e, n),
					a = l(t, e, n),
					o = 0 === l((a = a === t ? 0 : a === e ? 1 : 2), (s = s === t ? 0 : s === e ? 1 : 2)) ? (1 === c(a, s) ? 2 : 1) : 0;
				r[s] > r[a] ? ((r[o] = ((r[o] - r[a]) * i) / (r[s] - r[a])), (r[s] = i)) : (r[o] = r[s] = 0),
					(r[a] = 0),
					(C = r[0]),
					(S = r[1]),
					(k = r[2]);
			...
			var I = {
					...
					screen: function () {
						(C = y + g - (y * g) / 255), (S = w + p - (w * p) / 255), (k = x + v - (x * v) / 255);
					},
					overlay: function () {
						(C = y < 128 ? (2 * y * g) / 255 : 255 - (2 * (255 - y) * (255 - g)) / 255),
							(S = w < 128 ? (2 * w * p) / 255 : 255 - (2 * (255 - w) * (255 - p)) / 255),
							(k = x < 128 ? (2 * x * v) / 255 : 255 - (2 * (255 - x) * (255 - v)) / 255);
					},
					'soft-light': function () {
						var t = (g * y) / 255;
						(C = t + (y * (255 - ((255 - y) * (255 - g)) / 255 - t)) / 255),
							(S = (t = (p * w) / 255) + (w * (255 - ((255 - w) * (255 - p)) / 255 - t)) / 255),
							(k = (t = (v * x) / 255) + (x * (255 - ((255 - x) * (255 - v)) / 255 - t)) / 255);
					},
					'hard-light': function () {
						(C = g < 128 ? (2 * g * y) / 255 : 255 - (2 * (255 - g) * (255 - y)) / 255),
							(S = p < 128 ? (2 * p * w) / 255 : 255 - (2 * (255 - p) * (255 - w)) / 255),
							(k = v < 128 ? (2 * v * x) / 255 : 255 - (2 * (255 - v) * (255 - x)) / 255);
					},
					'color-dodge': function () {
						(C = 0 === y ? 0 : 255 === g ? 255 : l(255, (255 * y) / (255 - g))),
							(S = 0 === w ? 0 : 255 === p ? 255 : l(255, (255 * w) / (255 - p))),
							(k = 0 === x ? 0 : 255 === v ? 255 : l(255, (255 * x) / (255 - v)));
					},
					'color-burn': function () {
						(C = 255 === y ? 255 : 0 === g ? 0 : c(0, 255 - (255 * (255 - y)) / g)),
							(S = 255 === w ? 255 : 0 === p ? 0 : c(0, 255 - (255 * (255 - w)) / p)),
							(k = 255 === x ? 255 : 0 === v ? 0 : c(0, 255 - (255 * (255 - x)) / v));
					},
					darken: function () {
					...
					difference: function () {
						(C = y - g) < 0 && (C = -C), (S = w - p) < 0 && (S = -S), (k = x - v) < 0 && (k = -k);
					},
					exclusion: function () {
						(C = y + (g * (255 - y - y)) / 255), (S = w + (p * (255 - w - w)) / 255), (k = x + (v * (255 - x - x)) / 255);
					},
					hue: function () {
					...
					negation: function () {
						(C = 255 - t(255 - g - y)), (S = 255 - t(255 - p - w)), (k = 255 - t(255 - v - x));
					},
				},
				...
				(this.process = function (t, e, n, i, r) {
					...
					if (a || P[t])
						...
						for (
							...
							var d = (m * i) / 255,
								_ = 1 - d;
							(u[c] = d * C + _ * y), (u[c + 1] = d * S + _ * w), (u[c + 2] = d * k + _ * x), (u[c + 3] = m * i + _ * b);
						}
	...
	new (function () {
		...
		function f(t, e, n) {
			...
			return (
				e &&
					(t.isInvertible() ? ((i = (t = t._shiftless())._inverseTransform(l)), (l = null)) : (i = new Z()),
					(u[n ? 'cx' : 'x'] = i.x),
					(u[n ? 'cy' : 'y'] = i.y)),
				t.isIdentity() ||
					((r = t.decompose())
						? ((s = []),
							...
							(H.isZero(o.x - 1) && H.isZero(o.y - 1)) || s.push('scale(' + g.point(o) + ')'),
		...
		function t(t, e) {
			for (var n = f(t._matrix), i = t._children, r = rt.create('g', n, g), s = 0, a = i.length; s < a; s++) {
				var o,
					h = i[s],
					u = m(h, e);
				u &&
					(h.isClipMask()
						? ((o = rt.create('clipPath')).appendChild(u), v(h, o, 'clip'), rt.set(r, { 'clip-path': 'url(#' + o.id + ')' }))
						: r.appendChild(u));
			}
			return r;
		}
		function d(t) {
			...
			return (
				'rectangle' === r &&
					...
					(a.height = i),
					s.isZero() && (s = null)),
				s && ('circle' === r ? (a.r = s) : ((a.rx = s.width), (a.ry = s.height))),
				rt.create(r, a, g)
			);
		}
		var s,
			o = {
				...
				SymbolItem: function (t, e) {
					var n = f(t._matrix, !0),
						...
						a = s.getStrokeBounds();
					return (
						r || ((r = rt.create('symbol', { viewBox: g.rectangle(a) })).appendChild(m(s, e)), v(i, r, 'symbol')),
						(n.href = '#' + r.id),
						(n.x += a.x),
						(n.y += a.y),
						(n.width = a.width),
			...
			return (
				...
				U.each(st, function (t) {
					...
					(t.exportFilter ? !t.exportFilter(s, r) : o && U.equals(o[n](), r)) ||
						('color' !== i || null == r || ((e = r.getAlpha()) < 1 && (a[t.attribute + '-opacity'] = e)),
						'style' === i
												...
												? (function (t) {
														...
														if (!e) {
															var n,
																...
																a = t.getDestination();
															r
																? ((_ = { cx: s.x, cy: s.y, r: s.getDistance(a) }),
																	(n = t.getHighlight()) && ((_.fx = n.x), (_.fy = n.y)))
																: (_ = { x1: s.x, y1: s.y, x2: a.x, y2: a.y }),
																(_.gradientUnits = 'userSpaceOnUse'),
																(e = rt.create((r ? 'radial' : 'linear') + 'Gradient', _, g));
															for (var o = i._stops, h = 0, u = o.length; h < u; h++) {
																var l = o[h],
																	c = l._color,
																	f = c.getAlpha(),
																	d = l._offset,
		...
		function p(t, e) {
			return (s = s || { ids: {}, svgs: {} }), t && s.svgs[e + '-' + (t._id || t.__id || (t.__id = u.get('svg')))];
		}
		function v(t, e, n) {
			s || p();
		...
		function _(t, e) {
			...
			if (s) {
				for (var r in ((n = 'svg' === t.nodeName.toLowerCase() && t), s.svgs))
					i || (n || (n = rt.create('svg')).appendChild(t), (i = n.insertBefore(rt.create('defs'), n.firstChild))),
		...
		function m(t, e, n) {
			...
			return (
				a &&
					...
					(r = JSON.stringify(t._data)) && '{}' !== r && 'null' !== r && a.setAttribute('data-paper-data', r)),
				a && h(t, a, n)
			);
		}
		function y(t) {
		...
		D.inject({
			...
			l.inject({
				exportSVG: function (t) {
					...
					a && ((o.width = a.width), (o.height = a.height), (a.x || 0 === a.x || a.y || 0 === a.y) && (o.viewBox = g.rectangle(a)));
		...
		new (function () {
			...
			function _(t, e, n, i, r, s) {
				...
				return /%\s*$/.test(a) ? (o / 100) * (r ? 1 : p[/x|^width/.test(e) ? 'width' : 'height']) : o;
			}
			function g(t, e, n, i, r, s, a) {
				return (e = _(t, e || 'x', !1, i, r, s)), (n = _(t, n || 'y', !1, i, r, a)), !i || (null != e && null != n) ? new Z(e, n) : null;
			}
			function m(t, e, n, i, r) {
				return (e = _(t, e || 'width', !1, i, r)), (n = _(t, n || 'height', !1, i, r)), !i || (null != e && null != n) ? new W(e, n) : null;
			}
			function c(t, e, n) {
				return 'none' === t
					? null
			...
			function r(t, e, n, i) {
				var r = t.childNodes,
					...
					u = h._currentStyle,
					l = [];
				if ((s || a || ((o = w(o, t, i)), (h._currentStyle = o._style.clone())), i))
					for (var c = t.querySelectorAll('defs'), f = 0, d = c.length; f < d; f++) x(c[f], n, !1);
				for (f = 0, d = r.length; f < d; f++) {
					var _,
						g = r[f];
					1 !== g.nodeType || /^defs$/i.test(g.nodeName) || !(_ = x(g, n, !1)) || _ instanceof P || l.push(_);
				}
				return o.addChildren(l), s && (o = w(o.reduce(), t, i)), (h._currentStyle = u), (s || a) && (o.remove(), (o = null)), o;
			}
			function t(t, e) {
			...
			function e(t, e) {
				var n,
					...
					r = 'radialgradient' === e;
				if (i) (n = v[i].getGradient())._radial ^ r && ((n = n.clone())._radial = r);
				else {
				...
				return (
					r
						? ((c = (l = g(t, 'cx', 'cy', !1, d, '50%', '50%')).add(_(t, 'r', !1, !1, d, '50%'), 0)), (f = g(t, 'fx', 'fy', !0, d)))
						: ((l = g(t, 'x1', 'y1', !1, d, '0%', '0%')), (c = g(t, 'x2', 'y2', !1, d, '100%', '0%'))),
			...
			var y = {
				...
				use: function (t) {
					var e = (_(t, 'href', !0) || '').substring(1),
						n = v[e],
						i = g(t);
					return n ? (n instanceof P ? n.place(i) : n.clone().translate(i)) : null;
				},
				circle: function (t) {
					return new k.Circle(g(t, 'cx', 'cy'), _(t, 'r'));
				},
				ellipse: function (t) {
					return new k.Ellipse({ center: g(t, 'cx', 'cy'), radius: m(t, 'rx', 'ry') });
				},
				rect: function (t) {
			...
			function n(t, e, n, i) {
				if (t.transform) {
					for (var r = (i.getAttribute(n) || '').split(/\)\s*/g), s = new $(), a = 0, o = r.length; a < o; a++) {
						var h = r[a];
						if (!h) break;
				...
				),
				{
					...
					viewBox: function (t, e, n, i, r) {
						var s,
							...
							l = m(i, null, null, !0);
						t instanceof S
							? ((s = l ? l.divide(u.getSize()) : 1), (a = new $().scale(s).translate(u.getPoint().negate())), (o = t))
							: t instanceof P && (l && u.setSize(l), (o = t._item)),
							o &&
								('visible' !== f(i, 'overflow', r) && ((h = new k.Rectangle(u)).setClipMask(!0), o.addChild(h)), a && o.transform(a));
					},
				},
			);
			function f(t, e, n) {
				var i,
					...
					s = r && r.value;
				return (
					!s && t.style && ((i = U.camelize(e)), (s = t.style[i]) || n.node[i] === n.parent[i] || (s = n.node[i])),
					s ? ('none' === s ? null : s) : q
				);
			}
			function w(i, r, t) {
				var e = r.parentNode,
					s = { node: B.getStyles(r) || {}, parent: (!t && !/^defs$/i.test(e.tagName) && B.getStyles(e)) || {} };
				return (
			...
			function s(t) {
				var e = t && t.match(/\((?:["'#]*)([^"')]+)/),
					n = e && e[1],
					i = n && v[A ? n.replace(A.location.href.split('#')[0] + '#', '') : n];
			...
			function x(t, e, n) {
				...
				n &&
					...
					(p = m(t, null, null, !0) || p),
					(i = rt.create('svg', { style: 'stroke-width: 1px; stroke-miterlimit: 10' })),
					(r = t.parentNode),
					(s = t.nextSibling),
					i.appendChild(t),
					h.appendChild(i));
				...
				return (
					...
					i && (h.removeChild(i), r && (s ? r.insertBefore(t, s) : r.appendChild(t))),
					n && ((v = {}), g && U.pick(e.applyMatrix, l) && g.matrix.apply(!0, !0)),
					g
				);
			}
			function o(i, r, s) {
				...
				function t(t) {
					try {
						var e = 'object' == typeof t ? t : new C.DOMParser().parseFromString(t.trim(), 'image/svg+xml');
						if (!e.nodeName) throw ((e = null), new Error('Unsupported SVG source: ' + i));
						(at = a), (o = x(e, r, !0)), (r && !1 === r.insert) || s._insertItem(q, o);
						var n = r.onLoad;
						n && n(o, t);
					} catch (t) {
						h(t);
		...
		(U.exports.PaperScript = function () {
			...
			s ||
				...
				(i = function (t) {
					...
					function r(t) {
						for (var e in ((d = t || {}), i)) Object.prototype.hasOwnProperty.call(d, e) || (d[e] = i[e]);
						n = d.sourceFile || null;
					}
					var g,
						p,
					...
					t.tokenize = function (t, e) {
						...
						var n = {};
						function i(t) {
							return (C = s), Kt(t), (n.start = p), (n.end = s), (n.startLoc = a), (n.endLoc = o), (n.type = v), (n.value = m), n;
						}
						return (
							(i.jumpTo = function (t, e) {
								var n;
								if (((g = t), d.locations))
									for (w = 1, x = Vt.lastIndex = 0; (n = Vt.exec(_)) && n.index < t; ) ++w, (x = n.index + n[0].length);
								(y = e), Jt();
							}),
							i
						);
					...
					var Ot,
						...
						Ht = (t.isIdentifierChar = function (t) {
							return t < 48
								? 36 === t
								: t < 58 || (!(t < 65) && (t < 91 || (t < 97 ? 95 === t : t < 123 || (170 <= t && Dt.test(String.fromCharCode(t))))));
						});
					function Zt() {
					...
					function $t(t, e) {
						(s = g), d.locations && (o = new Zt()), (v = t), Jt(), (m = e), (y = t.beforeExpr);
					}
					function Gt() {
						for (
							var t = g, e = d.onComment && d.locations && new Zt(), n = _.charCodeAt((g += 2));
							g < f && 10 !== n && 13 !== n && 8232 !== n && 8233 !== n;

						)
							++g, (n = _.charCodeAt(g));
						d.onComment && d.onComment(!1, _.slice(t + 2, g), t, g, e, d.locations && new Zt());
					}
					function Jt() {
						for (; g < f; ) {
							var t,
							...
							if (32 === e) ++g;
								...
								++g, 10 === (t = _.charCodeAt(g)) && ++g, d.locations && (++w, (x = g));
							} else if (10 === e || 8232 === e || 8233 === e) ++g, d.locations && (++w, (x = g));
							else if (8 < e && e < 14) ++g;
							else if (47 === e) {
								if (42 === (t = _.charCodeAt(g + 1)))
									!(function () {
										var t,
											...
											n = g,
											i = _.indexOf('*/', (g += 2));
										if ((-1 === i && P(g - 2, 'Unterminated comment'), (g = i + 2), d.locations))
											for (Vt.lastIndex = n; (t = Vt.exec(_)) && t.index < g; ) ++w, (x = t.index + t[0].length);
										d.onComment && d.onComment(!0, _.slice(n + 2, i), n, g, e, d.locations && new Zt());
									})();
								else {
									if (47 !== t) break;
									Gt();
					...
					function Xt(t) {
						switch (t) {
							case 46:
								return 48 <= (c = _.charCodeAt(g + 1)) && c <= 57 ? ee(!0) : (++g, $t(dt));
							case 40:
								return ++g, $t(ht);
							case 41:
								return ++g, $t(ut);
								...
								return (function (t) {
									...
									for (var e = ''; ; ) {
										...
										if (92 === n) {
											...
											(13 !== n && 10 !== n && 8232 !== n && 8233 !== n) || P(p, 'Unterminated string constant'),
												(e += String.fromCharCode(n)),
												++g;
									}
								})(t);
							case 47:
								return (l = _.charCodeAt(g + 1)), y ? (++g, Yt()) : 61 === l ? Qt(vt, 2) : Qt(gt, 1);
							case 37:
							case 42:
							...
							case 38:
								return (
									(h = t),
									(u = _.charCodeAt(g + 1)) === h ? Qt(124 === h ? wt : xt, 2) : 61 === u ? Qt(vt, 2) : Qt(124 === h ? bt : St, 1)
								);
							case 94:
							...
							case 45:
								return (
									...
									(o = _.charCodeAt(g + 1)) === a
										? 45 == o && 62 == _.charCodeAt(g + 2) && qt.test(_.slice(C, g))
											? ((g += 3), Gt(), Jt(), Kt())
											: Qt(mt, 2)
										: 61 === o
											? Qt(vt, 2)
							...
							case 62:
								return (
									...
									r === i
										...
										: 33 == r && 60 == i && 45 == _.charCodeAt(g + 2) && 45 == _.charCodeAt(g + 3)
											? ((g += 4), Gt(), Jt(), Kt())
											: (61 === r && (s = 61 === _.charCodeAt(g + 2) ? 3 : 2), Qt(It, s))
								);
							case 61:
							case 33:
								return (n = t), 61 === _.charCodeAt(g + 1) ? Qt(kt, 61 === _.charCodeAt(g + 2) ? 3 : 2) : Qt(61 === n ? pt : yt, 1);
							case 126:
								return Qt(yt, 1);
						}
						var n, i, r, s, a, o, h, u, l, c;
					...
					function Kt(t) {
						if ((t ? (g = p + 1) : (p = g), d.locations && (a = new Zt()), t)) return Yt();
						if (f <= g) return $t(c);
					...
					function Yt() {
						for (var t, e, n = g; ; ) {
							...
							var i = _.charAt(g);
							if ((qt.test(i) && P(n, 'Unterminated regular expression'), t)) t = !1;
							else {
								if ('[' === i) e = !0;
								else if (']' === i && e) e = !1;
								else if ('/' === i && !e) break;
					...
					function te(t, e) {
						for (var n = g, i = 0, r = 0, s = null == e ? 1 / 0 : e; r < s; ++r) {
							var a = _.charCodeAt(g),
								o = 97 <= a ? a - 97 + 10 : 65 <= a ? a - 65 + 10 : 48 <= a && a <= 57 ? a - 48 : 1 / 0;
							if (t <= o) break;
							++g, (i = i * t + o);
						}
					...
					function ee(t) {
						var e = g,
							n = !1,
							i = 48 === _.charCodeAt(g);
						t || null !== te(10) || P(e, 'Invalid number'), 46 === _.charCodeAt(g) && (++g, te(10), (n = !0));
						var r = _.charCodeAt(g);
						(69 !== r && 101 !== r) ||
							((43 !== (r = _.charCodeAt(++g)) && 45 !== r) || ++g, null === te(10) && P(e, 'Invalid number'), (n = !0)),
							Ut(_.charCodeAt(g)) && P(g, 'Identifier directly after number');
						var s,
							a = _.slice(e, g);
						return (
					...
					function ie() {
						for (var t, e = !(Ot = !1), n = g; ; ) {
							...
							if (Ht(i)) Ot && (t += _.charAt(g)), ++g;
								...
								Ot || (t = _.slice(n, g)),
									(Ot = !0),
									117 != _.charCodeAt(++g) && P(g, 'Expecting Unicode escape sequence \\uXXXX'),
									++g;
								var r = ne(4),
									s = String.fromCharCode(r);
								s || P(g - 1, 'Invalid Unicode escape'), (e ? Ut : Ht)(r) || P(g - 4, 'Invalid Unicode escape'), (t += s);
							}
							e = !1;
						}
					...
					function ae(t) {
						if (((I = t), (g = p), d.locations)) for (; g < x; ) (x = _.lastIndexOf('\n', x - 2) + 1), --w;
						Jt(), Kt();
					}
					function oe() {
					...
					function ce(t, e) {
						return (t.type = e), (t.end = C), d.locations && (t.loc.end = h), d.ranges && (t.range[1] = C), t;
					}
					function fe(t) {
						return (
							5 <= d.ecmaVersion &&
					...
					function _e() {
						return !d.strictSemicolons && (v === c || v === ot || qt.test(_.slice(C, p)));
					}
					function ge() {
						de(ct) || _e() || ve();
					}
					...
					function me(t) {
						'Identifier' !== t.type && 'MemberExpression' !== t.type && P(t.start, 'Assigning to rvalue'),
							I && 'Identifier' === t.type && Nt(t.name) && P(t.start, 'Assigning to ' + t.name + ' in strict mode');
					}
					var ye = { kind: 'loop' },
						we = { kind: 'switch' };
					function xe() {
						...
						switch (r) {
							...
							case N:
								se();
								var a = r === z;
								de(ct) || _e() ? (s.label = null) : v !== O ? ve() : ((s.label = Ne()), ge());
								...
								return o === k.length && P(s.start, 'Unsyntactic ' + r.keyword), ce(s, a ? 'BreakStatement' : 'ContinueStatement');
							case B:
								return se(), ge(), ce(s, 'DebuggerStatement');
							case j:
								return se(), k.push(ye), (s.body = xe()), k.pop(), pe(J), (s.test = be()), ge(), ce(s, 'DoWhileStatement');
							case q:
								if ((se(), k.push(ye), pe(ht), v === ct)) return Se(s, null);
								if (v === G) {
									var u = ue();
									return se(), Ie(u, !0), ce(u, 'VariableDeclaration'), (1 === u.declarations.length && de(nt) ? ke : Se)(s, u);
								}
								u = Pe(!1, !0);
							...
							case V:
								return se(), Ee(s, !0);
							case U:
								return se(), (s.test = be()), (s.consequent = xe()), (s.alternate = de(R) ? xe() : null), ce(s, 'IfStatement');
							case H:
								return (
									S || d.allowReturnOutsideFunction || P(p, "'return' outside of function"),
									se(),
									de(ct) || _e() ? (s.argument = null) : ((s.argument = Pe()), ge()),
									ce(s, 'ReturnStatement')
								);
							case Z:
								se(), (s.discriminant = be()), (s.cases = []), pe(at), k.push(we);
								for (; v != ot; ) {
									v === E || v === F
										? ((n = v === E),
											t && ce(t, 'SwitchCase'),
											...
											(t.consequent = []),
											se(),
											n ? (t.test = Pe()) : (e && P(b, 'Multiple default clauses'), (e = !0), (t.test = null)),
											pe(ft))
										: (t || ve(), t.consequent.push(xe()));
								}
								return t && ce(t, 'SwitchCase'), se(), k.pop(), ce(s, 'SwitchStatement');
							case W:
								return (
									se(),
							...
							case $:
								return (
									...
									v === L &&
										...
										pe(ht),
										(i.param = Ne()),
										I && Nt(i.param.name) && P(i.param.start, 'Binding ' + i.param.name + ' in strict mode'),
										pe(ut),
										(i.guard = null),
										(i.body = Ce()),
									...
									s.handler || s.finalizer || P(s.start, 'Missing catch or finally clause'),
									ce(s, 'TryStatement')
								);
							case G:
								return se(), Ie(s), ge(), ce(s, 'VariableDeclaration');
							case J:
								return se(), (s.test = be()), k.push(ye), (s.body = xe()), k.pop(), ce(s, 'WhileStatement');
							case X:
								return I && P(p, "'with' in strict mode"), se(), (s.object = be()), (s.body = xe()), ce(s, 'WithStatement');
							case at:
								return Ce();
							case ct:
							...
							default:
								...
								if (r === O && 'Identifier' === c.type && de(ft)) {
									for (o = 0; o < k.length; ++o) k[o].name === l && P(c.start, "Label '" + l + "' is already declared");
									var f = v.isLoop ? 'loop' : v === Z ? 'switch' : null;
									return k.push({ name: l, kind: f }), (s.body = xe()), k.pop(), (s.label = c), ce(s, 'LabeledStatement');
								}
					...
					function ke(t, e) {
						return (t.left = e), (t.right = Pe()), pe(ut), (t.body = xe()), k.pop(), ce(t, 'ForInStatement');
					}
					function Ie(t, e) {
						for (t.declarations = [], t.kind = 'var'; ; ) {
							...
							if (
								((n.id = Ne()),
								I && Nt(n.id.name) && P(n.id.start, 'Binding ' + n.id.name + ' in strict mode'),
					...
					function Me(t) {
							...
							var e = (function (t) {
								return (function t(e, n, i) {
									...
									if (null != r && (!i || v !== nt) && n < r) {
										...
										var a = v;
										se(), (s.right = t(Ae(), r, i));
										var o = ce(s, a === wt || a === xt ? 'LogicalExpression' : 'BinaryExpression');
										return t(o, n, i);
									}
									return e;
								})(Ae(), -1, t);
						...
						if (v.isAssign) {
							var n = le(e);
							return (n.operator = m), (n.left = e), se(), (n.right = Me(t)), me(e), ce(n, 'AssignmentExpression');
						}
						return e;
					}
					function Ae() {
						...
						for (var n = Te(Oe()); v.postfix && !_e(); ) {
							((t = le(n)).operator = m), (t.prefix = !1), me((t.argument = n)), se(), (n = ce(t, 'UpdateExpression'));
						}
						return n;
					}
					function Te(t, e) {
						var n;
						return de(dt)
							? (((n = le(t)).object = t), (n.property = Ne(!0)), (n.computed = !1), Te(ce(n, 'MemberExpression'), e))
							: de(rt)
								? (((n = le(t)).object = t), (n.property = Pe()), (n.computed = !0), pe(st), Te(ce(n, 'MemberExpression'), e))
								: e || !de(ht)
									? t
									: (((n = le(t)).callee = t), (n.arguments = Le(ut, !1)), Te(ce(n, 'CallExpression'), e));
					}
					function Oe() {
						switch (v) {
							case Q:
							...
							case T:
							case l:
								return ((t = ue()).value = m), (t.raw = _.slice(p, s)), se(), ce(t, 'Literal');
							case Y:
							case tt:
							case et:
								return ((t = ue()).value = v.atomValue), (t.raw = v.keyword), se(), ce(t, 'Literal');
							case ht:
								var e = a,
									n = p;
								se();
									...
									for (; !de(ot); ) {
										...
										if (
											(de(ft)
												...
												: 5 <= d.ecmaVersion && 'Identifier' === r.key.type && ('get' === r.key.name || 'set' === r.key.name)
													? ((s = n = !0),
														(i = r.kind = r.key.name),
														(r.key = ze()),
														v !== ht && ve(),
							...
							case K:
								return (function () {
									var t = ue();
									se(), (t.callee = Te(Oe(), !0)), de(ht) ? (t.arguments = Le(ut, !1)) : (t.arguments = M);
					...
					function Ee(t, e) {
						...
						var i = S,
							r = k;
						if (((S = !0), (k = []), (t.body = Ce(!0)), (S = i), (k = r), I || (t.body.body.length && fe(t.body.body[0]))))
							for (var s = t.id ? -1 : 0; s < t.params.length; ++s) {
								var a = s < 0 ? t.id : t.params[s];
								if (((Lt(a.name) || Nt(a.name)) && P(a.start, "Defining '" + a.name + "' in strict mode"), 0 <= s))
									for (var o = 0; o < s; ++o) a.name === t.params[o].name && P(a.start, 'Argument name clash in strict mode');
							}
					...
					function Ne(t) {
						...
						return (
							...
							v === O
								? (!t &&
										((d.forbidReserved && (3 === d.ecmaVersion ? zt : Et)(m)) || (I && Lt(m))) &&
			...
			function b(f, t) {
				...
				function g(t, e) {
					for (var n = d(t.range[0]), i = d(t.range[1]), r = 0, s = a.length - 1; 0 <= s; s--)
						if (n > a[s][0]) {
							r = s + 1;
							break;
						}
					a.splice(r, 0, [n, e.length - i + n]), (f = f.substring(0, n) + e + f.substring(i));
				}
				function h(t, e) {
					switch (t.type) {
						case 'UnaryExpression':
							t.operator in x && 'Literal' !== t.argument.type && ((r = _(t.argument)), g(t, '$__("' + t.operator + '", ' + r + ')'));
							break;
						case 'BinaryExpression':
							...
							t.operator in w &&
								...
								(i = t.operator),
								g(t, '__$__(' + a + ',' + n.replace(new RegExp('\\' + i), '"' + i + '"') + ', ' + o + ')'));
							break;
						...
						case 'AssignmentExpression':
							...
							'ForStatement' === u ||
								...
								('UpdateExpression' === t.type
									? ((s = (r = _(t.argument)) + ' = ' + (h = '__$__(' + r + ', "' + t.operator[0] + '", 1)')),
										t.prefix
											? (s = '(' + s + ')')
											: ('AssignmentExpression' !== u && 'VariableDeclarator' !== u && 'BinaryExpression' !== u) ||
												(_(e.left || e.id) === r && (s = h), (s = r + '; ' + s)),
										g(t, s))
									: /^.=$/.test(t.operator) &&
										'Literal' !== t.left.type &&
										((a = _(t.left)),
										(o = _(t.right)),
										(h = a + ' = __$__(' + a + ', "' + t.operator[0] + '", ' + o + ')'),
										g(t, /^\(.*\)$/.test(_(t)) ? '(' + h + ')' : h)));
					}
					var l, c;
				}
				...
				return (
					s &&
						((c.chrome && 30 <= p) || (c.webkit && 537.76 <= p) || (c.firefox && 23 <= p) || c.node) &&
						(c.node
							? (l -= 2)
							: A &&
								r &&
								!A.location.href.indexOf(r) &&
								(l = (n = T.getElementsByTagName('html')[0].innerHTML).substr(0, n.indexOf(f) + 1).match(m).length + 1),
						((i = [
							'AA' +
								(function (t) {
									var e = '';
									...
									return e;
								})((v = 0 < l && !((c.chrome && 36 <= p) || (c.safari && 600 <= p) || (c.firefox && 40 <= p) || c.node)) ? 0 : l) +
								'A',
						]).length = (f.match(m) || []).length + 1 + (v ? l : 0)),
						(e = { version: 3, file: r, names: [], mappings: i.join(';AACA'), sourceRoot: '', sources: [r], sourcesContent: [u] })),
					(!1 === o.operatorOverloading && !1 === o.moduleExports) ||
						(function t(e, n, i) {
							if (e) {
								for (var r in e)
									if ('range' !== r && 'loc' !== r) {
										var s = e[r];
										if (Array.isArray(s)) for (var a = 0, o = s.length; a < o; a++) t(s[a], e, i);
										...
										(function (t) {
											switch (t.type) {
												case 'ExportDefaultDeclaration':
													g({ range: [t.start, t.declaration.start] }, 'module.exports = ');
													break;
												case 'ExportNamedDeclaration':
													...
													i
														? (e = i.declarations) &&
															...
															g({ range: [t.start, i.start + i.kind.length] }, ''))
														: !r ||
															((n = r
																.map(function (t) {
																	var e = _(t);
						...
						})(y(f, { ranges: !0, preserveParens: !0, sourceType: 'module' }), null, o),
					e &&
						(v && (f = new Array(l + 1).join('\n') + f),
						/^(inline|both)$/.test(s) &&
							(f += '\n//# sourceMappingURL=data:application/json;base64,' + C.btoa(unescape(encodeURIComponent(JSON.stringify(e))))),
			...
			function o(i, t, e) {
				var n,
					r = (at = t).getView(),
					s = /\btool\.\w+|\s+on(?:Key|Mouse)(?:Up|Down|Move|Drag)\b/.test(i) && !/\bnew\s+Tool\b/.test(i) ? new et() : null,
					a = s ? s._events : [],
				...
				function c(t, e) {
					for (var n in t)
						(!e && /^_/.test(n)) || !new RegExp('([\\b\\s\\W]|^)' + n.replace(/\$/g, '\\$') + '\\b').test(i) || (h.push(n), u.push(t[n]));
				}
				(i = l.code), c({ __$__: v, $__: m, paper: t, tool: s }, !0), c(t), (i = 'var module = { exports: {} }; ' + i);
				var f = U.each(
					o,
					function (t) {
				...
				T && (g.chrome || (g.firefox && g.versionNumber < 40))
					? ((d = T.createElement('script')),
						...
						g.firefox && (i = '\n' + i),
						d.appendChild(T.createTextNode('document.__paperscript__ = function(' + h + ') {' + i + '\n}')),
						_.appendChild(d),
						(n = T.__paperscript__),
			...
			function h(t) {
				if (/^text\/(?:x-|)paperscript$/.test(t.type) && 'true' !== c.getAttribute(t, 'ignore')) {
			...
			return (
				...
				W.inject(a),
				E.inject(a),
				A && ('complete' === T.readyState ? setTimeout(u) : F.add(A, { load: u })),
				{
					compile: b,
					execute: o,
					load: function (t) {
	...
	return (
		at.agent.node && require('./node/extend.js')(at),
		'function' == typeof define && define.amd ? define('paper', at) : 'object' == typeof module && module && (module.exports = at),
		at
	);
